...
def convert_mdv_to_slave_param_v2 (thread_number, var, demand, piecewise_steps):
    
    import sys 
    sys.path.append('C:\\Optimization_zlc\\master_level_models\\conference_network_only_master_level_models\\prep_functions\\')
    import os.path
