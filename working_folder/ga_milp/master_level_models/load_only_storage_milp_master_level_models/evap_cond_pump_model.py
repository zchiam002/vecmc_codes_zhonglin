...
def evap_pump_ch1 ():
    ...
    ##Maximum pressure at maximum rpm
    pumpaf1_maxpressure = 15
    af1_flow_limit = 250
    ...
    ch1_evap_x2_coeff, ch1_evap_x_coeff = convert_to_quadratic(ch1_evap_A_val, af1_flow_limit)
...
#    plt.show()
    ...
    ch1_evap_pump_max_pressure = pumpaf1_maxpressure
    ch1_evap_pump_regress_r2 = result
    
    ret_values = np.zeros((6,1))
    ...
    ret_values[4,0] = ch1_evap_pump_max_pressure
    ret_values[5,0] = ch1_evap_pump_regress_r2
...
def evap_pump_ch2 ():
    ...
    ##Evaluating the intersection points for the pump and system curves for the lowest pressure drop case 
    ch2_evap_x2_coeff, ch2_evap_x_coeff = convert_to_quadratic(ch2_evap_A_val, af2_flow_limit)
    ...
    ch2_evap_pump_max_pressure = pumpaf2_maxpressure
    ...
    ret_values[4,0] = ch2_evap_pump_max_pressure
    ret_values[5,0] = ch2_evap_pump_regress_r2
...
def evap_pump_ch3 ():
    ...
    ##Evaluating the intersection points for the pump and system curves for the lowest pressure drop case 
    ch3_evap_x2_coeff, ch3_evap_x_coeff = convert_to_quadratic(ch3_evap_A_val, af3_flow_limit)
    ...
    ch3_evap_pump_max_pressure = pumpaf3_maxpressure
    ...
    ret_values[4,0] = ch3_evap_pump_max_pressure
    ret_values[5,0] = ch3_evap_pump_regress_r2
...
def cond_pump_ch1 ():
    ...
    ##Evaluating the intersection points for the pump and system curves for the lowest pressure drop case 
    ch1_cond_x2_coeff, ch1_cond_x_coeff = convert_to_quadratic(ch1_cond_A_val, ar1_flow_limit)
    ##ch1_eflow_max[0] - maximum flowrate for this given combination 
    ...
    ch1_cond_pump_max_pressure = pumpar1_maxpressure
    ...
    ret_values[4,0] = ch1_cond_pump_max_pressure    
    ret_values[5,0] = ch1_cond_pump_regress_r2
...
def cond_pump_ch2 ():
    ...
    ##Evaluating the intersection points for the pump and system curves for the lowest pressure drop case 
    ch2_cond_x2_coeff, ch2_cond_x_coeff = convert_to_quadratic(ch2_cond_A_val, ar2_flow_limit)
    ##ch2_eflow_max[0] - maximum flowrate for this given combination 
    ...
    ch2_cond_pump_max_pressure = pumpar2_maxpressure
    ...
    ret_values[4,0] = ch2_cond_pump_max_pressure 
    ret_values[5,0] = ch2_cond_pump_regress_r2
...
def cond_pump_ch3 ():
    ...
    ##Evaluating the intersection points for the pump and system curves for the lowest pressure drop case 
    ch3_cond_x2_coeff, ch3_cond_x_coeff = convert_to_quadratic(ch3_cond_A_val, ar3_flow_limit)
    ##ch3_eflow_max[0] - maximum flowrate for this given combination 
    ...
    ch3_cond_pump_max_pressure = pumpar3_maxpressure
    ...
    ret_values[4,0] = ch3_cond_pump_max_pressure 
    ret_values[5,0] = ch3_cond_pump_regress_r2
