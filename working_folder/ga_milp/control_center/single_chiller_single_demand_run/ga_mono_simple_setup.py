...
def ga_mono_simple_setup():   
    ...
    selection_choice_data['tournament_size'] = 2     ##Tournament size should not exceed half of the population size
...
def prerun ():
    ...
    import sys 
    sys.path.append('C:\\Optimization_zlc\\master_level_models\\single_chiller_single_demand_run\\')
...
def variable_def (time_steps):
    ...
    for i in range (0, time_steps):
        ...
        initial_variable_values[0,:] = [276.3409091, 293.0396774, 1627.853481, 528.5300937, 275.2742815, 290.3480352, 499.9012952, 3.079584463]
        initial_variable_values[1,:] = [275.5155425, 291.1184018, 256.2034691, 1512.052134, 276.0742522, 289.3641935, 537.2570746, 2.056389642]
        initial_variable_values[2,:] = [276.5504252, 289.5219795, 1821.692599, 1350.715095, 275.2361877, 289.2806598, 477.5475735, 5.125974106]        
