...
def ga_mono_nb_conv_info (variable_list):
    ...
    for i in range (0, dim_variable_list[0]):
        ...
        if variable_list['Type'][i] == 'continuous':
            ...
            discrete_steps = (round_upper_bound * pow(10, variable_list['Dec_prec'][i])) - (round_lower_bound * pow(10, variable_list['Dec_prec'][i]))
            ...
            discrete_steps = variable_list['Steps'][i]
