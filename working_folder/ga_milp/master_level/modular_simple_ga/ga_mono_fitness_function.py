...
def ga_mono_fitness_function (agents_and_obj_vals, total_binary_len):
   ...
   ##total_binary_len --- total length of the binary combination, this information is important for determining which column contains the objective function value
