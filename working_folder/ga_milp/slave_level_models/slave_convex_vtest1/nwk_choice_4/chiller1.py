...
def chiller1 (ch1_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    ...
    ch1_1_e['Coeff_v1_1'] = chiller1['ch1_totalenwkflow']['value'] * 998.2 * chiller1['ch1_cp']['value'] * chiller1['ch1_evaptret']['value'] / 3600         ##The relationship is Qe = m_evap_perc*m_total*Cp*Tevap_in - m_evap_perc*m_total*Cp*Tevap_out
    ch1_1_e['Coeff_v2_2'] = 0
    ch1_1_e['Coeff_v2_1'] = 0
    ch1_1_e['Coeff_v1_v2'] = -chiller1['ch1_totalenwkflow']['value'] * chiller1['ch1_cp']['value'] * 998.2 / 3600
    ch1_1_e['Coeff_cst'] = 0
    ...
    ch1_1_c['Coeff_v1_1'] = -chiller1['ch1_totalcnwkflow']['value'] * 998.2 * chiller1['ch1_cp']['value'] * chiller1['ch1_condtin']['value'] / 3600         ##The relationship is Qc = m_cond_perc*m_total*Cp*Tcond_in - m_cond_perc*m_total*Cp*Tcond_out
    ch1_1_c['Coeff_v2_2'] = 0
    ch1_1_c['Coeff_v2_1'] = 0
    ch1_1_c['Coeff_v1_v2'] = chiller1['ch1_totalcnwkflow']['value'] * chiller1['ch1_cp']['value'] * 998.2 / 3600
    ch1_1_c['Coeff_cst'] = 0
    ...
    ch1_2_e['Coeff_v1_1'] = chiller1['ch1_totalenwkflow']['value'] * 998.2 * chiller1['ch1_cp']['value'] * chiller1['ch1_evaptret']['value'] / 3600        ##The relationship is Qe = m_evap_perc*m_total*Cp*Tevap_in - m_evap_perc*m_total*Cp*Tevap_out
    ch1_2_e['Coeff_v2_2'] = 0
    ch1_2_e['Coeff_v2_1'] = 0
    ch1_2_e['Coeff_v1_v2'] = -chiller1['ch1_totalenwkflow']['value'] * chiller1['ch1_cp']['value'] * 998.2 / 3600
    ch1_2_e['Coeff_cst'] = 0
    ...
    ch1_2_c['Coeff_v1_1'] = -chiller1['ch1_totalcnwkflow']['value'] * 998.2 * chiller1['ch1_cp']['value'] * chiller1['ch1_condtin']['value'] / 3600          ##The relationship is Qc = m_cond_perc*m_total*Cp*Tcond_in - m_cond_perc*m_total*Cp*Tcond_out
    ch1_2_c['Coeff_v2_2'] = 0
    ch1_2_c['Coeff_v2_1'] = 0
    ch1_2_c['Coeff_v1_v2'] = chiller1['ch1_totalcnwkflow']['value'] * chiller1['ch1_cp']['value'] * 998.2 / 3600
    ch1_2_c['Coeff_cst'] = 0
    ...
    ch1_3_e['Coeff_v1_1'] = chiller1['ch1_totalenwkflow']['value'] * 998.2 * chiller1['ch1_cp']['value'] * chiller1['ch1_evaptret']['value'] / 3600         ##The relationship is Qe = m_evap_perc*m_total*Cp*Tevap_in - m_evap_perc*m_total*Cp*Tevap_out
    ch1_3_e['Coeff_v2_2'] = 0
    ch1_3_e['Coeff_v2_1'] = 0
    ch1_3_e['Coeff_v1_v2'] = -chiller1['ch1_totalenwkflow']['value'] * chiller1['ch1_cp']['value'] * 998.2 / 3600
    ch1_3_e['Coeff_cst'] = 0
    ...
    ch1_3_c['Coeff_v1_1'] = -chiller1['ch1_totalcnwkflow']['value'] * 998.2 * chiller1['ch1_cp']['value'] * chiller1['ch1_condtin']['value'] / 3600       ##The relationship is Qc = m_cond_perc*m_total*Cp*Tcond_in - m_cond_perc*m_total*Cp*Tcond_out
    ch1_3_c['Coeff_v2_2'] = 0
    ch1_3_c['Coeff_v2_1'] = 0
    ch1_3_c['Coeff_v1_v2'] = chiller1['ch1_totalcnwkflow']['value'] * chiller1['ch1_cp']['value'] * 998.2 / 3600
    ch1_3_c['Coeff_cst'] = 0
    ...
    ch1_4_e['Coeff_v1_1'] = chiller1['ch1_totalenwkflow']['value'] * 998.2 * chiller1['ch1_cp']['value'] * chiller1['ch1_evaptret']['value'] / 3600         ##The relationship is Qe = m_evap_perc*m_total*Cp*Tevap_in - m_evap_perc*m_total*Cp*Tevap_out
    ch1_4_e['Coeff_v2_2'] = 0
    ch1_4_e['Coeff_v2_1'] = 0
    ch1_4_e['Coeff_v1_v2'] = -chiller1['ch1_totalenwkflow']['value'] * chiller1['ch1_cp']['value'] * 998.2 / 3600
    ch1_4_e['Coeff_cst'] = 0
    ...
    ch1_4_c['Coeff_v1_1'] = -chiller1['ch1_totalcnwkflow']['value'] * 998.2 * chiller1['ch1_cp']['value'] * chiller1['ch1_condtin']['value'] / 3600         ##The relationship is Qc = m_cond_perc*m_total*Cp*Tcond_in - m_cond_perc*m_total*Cp*Tcond_out
    ch1_4_c['Coeff_v2_2'] = 0
    ch1_4_c['Coeff_v2_1'] = 0
    ch1_4_c['Coeff_v1_v2'] = chiller1['ch1_totalcnwkflow']['value'] * chiller1['ch1_cp']['value'] * 998.2 / 3600
    ch1_4_c['Coeff_cst'] = 0
