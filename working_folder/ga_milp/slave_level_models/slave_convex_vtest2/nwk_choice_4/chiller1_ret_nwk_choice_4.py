...
def checktype_chiller1_ret_nwk_choice_4 (unit_type):                  ##Input the unit type here
    unit_type = 'process'
    return unit_type
    
def chiller1_ret_nwk_choice_4 (ch1_r_mdv, processlist, streams, cons_eqns, cons_eqns_terms):
    import pandas as pd 
    import numpy as np 
    ...
    ##Unit 1
    ud = {}
    ud['Name'] = 'ch1_evap_ret'
    ud['Variable1'] = 't_in'                                                                                                     
    ud['Variable2'] = '-' 
    ud['Fmin_v1'] = 0 
    ud['Fmax_v1'] = ch1_r_etret                                                                                                                   
    ud['Fmin_v2'] = 0                                                                                                          
    ud['Fmax_v2'] = 0                                                                                   
    ud['Coeff_v1_2'] = 0                                                                                                                
    ud['Coeff_v1_1'] = 0          
    ...
    stream = {}                                                                
    stream['Parent'] = 'ch1_evap_ret'
    stream['Type'] = 'balancing_only'
    stream['Name'] = 'ch1_evap_tin'
