...
def ice_nwk (ice_nwk_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    ...
    ##ice_nwk_mdv --- the master decision variables which are used as parameters at this stage 
    ...
    ice_nwk_steps = ice_nwk_mdv['Value'][0]
    ice_nwk_tf = ice_nwk_mdv['Value'][1]
    ice_nwk_max_flow = ice_nwk_mdv['Value'][1]                    ##This upper bound is needed for the computation of stepwise pressure
