...
def checktype_chiller2_evap (unit_type):                  ##Input the unit type here
    unit_type = 'utility'
    return unit_type

def chiller2_evap (ch2_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    from chiller2_evap_compute import chiller2_evap_compute
    import pandas as pd
    import numpy as np
    
    ##This is the evaporator side of chiller2_evap
    ...
    ch2_ret_vals = chiller2_evap_compute(ch2_dc)
...
############################################################################################################################################################################################################
    ...
    for i in range (0, int(ch2_steps)):   
        ...
        term['Parent_eqn'] = 'totaluse_ch2_e'
        ...
        term = {}
        term['Parent_unit'] = 'ch2_' + str(i + 1) + '_evap'
        term['Parent_eqn'] = 'ch2_e_flow_min'
        term['Parent_stream'] = '-'                                    ##Only applicable for stream_limit types 
        term['Coefficient'] = 0
        term['Coeff_v1_2'] = 0                                         ##Only applicable for stream_limit_modified types 
