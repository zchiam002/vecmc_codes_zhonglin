...
def slave_test_script():
    ...
    sys.path.append('C:\\Optimization_zlc\\master_level_models\\3_chiller_1_demand_24ts_3_period_gurobipy_master_level_models\\')
    sys.path.append('C:\\Optimization_zlc\\slave_level_models\\3_chiller_1_demand_24ts_3_period_gurobipy_slave\\')
    ...
    ##multi-time parameters or else input 'na'
    obj_weights = 'na'
    time_steps = 'na'
    ...
    for i in range (0, time_steps_test):
        ...
        obj_value, results, results_y = cvx_prog_run(parallel_thread_num, bilinear_pieces, solver_choice, obj_weights, time_steps)
