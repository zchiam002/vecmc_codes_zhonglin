...
def checktype_chiller1_evap_nwk_4nc (unit_type):                  ##Input the unit type here
    unit_type = 'utility'
    return unit_type

def chiller1_evap_nwk_4nc (ch1_enwk_4nc_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    from chiller1_evap_nwk_4nc_compute import chiller1_evap_nwk_4nc_compute
    import pandas as pd
    import numpy as np
    ...
    ##ch1_enwk_4nc_mdv --- the master decision variables which are used as parameters at this stage 
    ...
    ch1_enwk_steps = ch1_enwk_4nc_mdv['Value'][0]
    ch1_enwk_tf = ch1_enwk_4nc_mdv['Value'][1]                  
    ...
    ch1_enwk_calc = chiller1_evap_nwk_4nc_compute(ch1_enwk_dc)
...
####################################################################################################################################################################################################        
    ...
    for i in range (0, int(ch1_enwk_steps)):
        ...
        stream = {}                         
        stream['Parent'] = 'ch1_enwk_4nc_' + str(i + 1)
        stream['Type'] = 'flow'
        stream['Name'] = 'ch1_enwk_4nc_' + str(i + 1) + '_flow_in'
        ...
        stream['Parent'] = 'ch1_enwk_4nc_' + str(i + 1)
        stream['Type'] = 'flow'
        stream['Name'] = 'ch1_enwk_4nc_' + str(i + 1) + '_flow_out'
        ...
        stream['Name'] = 'ch1_enwk_4nc_' + str(i + 1) + '_delp_out'
...
############################################################################################################################################################################################################
    ...
    eqn = {}
    eqn['Name'] = 'totaluse_ch1_enwk_4nc'
    ...
    for i in range (0, int(ch1_enwk_steps)):   
        term = {}
        term['Parent_unit'] = 'ch1_enwk_4nc_' + str(i + 1)
        term['Parent_eqn'] = 'totaluse_ch1_enwk_4nc'
