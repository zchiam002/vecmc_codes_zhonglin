## This is a chiller condenser return model for temperature, formulated as an input to a quadratic program
...
def checktype_chiller_ret_cond_4nc (unit_type):                  ##Input the unit type here
    unit_type = 'process'
    return unit_type
    
def chiller_ret_cond_4nc (ch_r_c_4nc_mdv, processlist, streams, cons_eqns, cons_eqns_terms):
    import pandas as pd 
    import numpy as np 

    ##Model description:
    ##This model represents the required condenser return temperature demand from the cooling towers
    
    ##Legend of input variables 
    
    ##ch1_r_ctin       - condenser return temperature (K)
    
    ##Defining inputs 
    
    ##Processing list of master decision variables as parameters 
    ch1_r_ctin = ch_r_c_4nc_mdv['Value'][0]

    ##Unit definition 
    
    ##Unit 1
    ud = {}
    ud['Name'] = 'ch_cond_tin_4nc'
    ud['Variable1'] = 't_in'                                                                                                     
    ud['Variable2'] = '-' 
    ud['Fmin_v1'] = 0 
    ud['Fmax_v1'] = 1                                                                                                                
    ...
    stream = {}                                                                
    stream['Parent'] = 'ch_cond_tin_4nc'
    stream['Type'] = 'balancing_only'
    stream['Name'] = 'ch_cond_4nc_tin'
    stream['Layer'] = 'sp4_2_condin_temp'
    stream['Stream_coeff_v1_2'] = 0
    stream['Stream_coeff_v1_1'] = ch1_r_ctin
