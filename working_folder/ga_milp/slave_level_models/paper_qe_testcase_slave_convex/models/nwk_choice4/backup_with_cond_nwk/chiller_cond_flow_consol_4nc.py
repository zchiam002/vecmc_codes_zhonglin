...
def checktype_chiller_cond_flow_consol_4nc (unit_type):                  ##Input the unit type here
    unit_type = 'process'
    return unit_type
    
def chiller_cond_flow_consol_4nc (ch_c_f_c_4nc_mdv, processlist, streams, cons_eqns, cons_eqns_terms):
    import pandas as pd
    ...
    ch_c_f_c_tf = ch_c_f_c_4nc_mdv['Value'][0]
    
    ##Unit definition 
    
    ##Unit 1 
    ud = {}
    ud['Name'] = 'ch_c_f_c_4nc'
    ud['Variable1'] = 'm_perc'                                                                                                                 
    ud['Variable2'] = '-'                                                                                                          
    ud['Fmin_v1'] = 0 
    ud['Fmax_v1'] = 1                                                                                                                 
    ...
    stream['Parent'] = 'ch_c_f_c_4nc'
    stream['Type'] = 'balancing_only'
    stream['Name'] = 'ch_c_f_c_4nc_flow_in'
    stream['Layer'] = 'cond_nwk_flow' 
    stream['Stream_coeff_v1_2'] = 0
    stream['Stream_coeff_v1_1'] = ch_c_f_c_tf 
