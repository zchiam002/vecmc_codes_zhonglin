...
def checktype_tro_nwk_4nc (unit_type):                  ##Input the unit type here
    unit_type = 'utility'
    return unit_type

def tro_nwk_4nc (tro_nwk_4nc_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    ...
    ##tro_nwk_4nc_mdv --- the master decision variables which are used as parameters at this stage 
    ...
    tro_nwk_steps = tro_nwk_4nc_mdv['Value'][0]
    tro_nwk_tf = tro_nwk_4nc_mdv['Value'][1]
    tro_nwk_max_flow = tro_nwk_4nc_mdv['Value'][1]  * 0.5                 ##This upper bound is needed for the computation of stepwise pressure
...
####################################################################################################################################################################################################        
    ...
    for i in range (0, int(tro_nwk_steps)):
        ...
        stream = {}                         
        stream['Parent'] = 'tro_nwk_4nc_' + str(i + 1)
        stream['Type'] = 'flow'
        stream['Name'] = 'tro_nwk_4nc_' + str(i + 1) + '_flow_in'
        ...
        stream['Parent'] = 'tro_nwk_4nc_' + str(i + 1)
        stream['Type'] = 'flow'
        stream['Name'] = 'tro_nwk_4nc_' + str(i + 1) + '_flow_out'
        ...
        stream['Name'] = 'tro_nwk_4nc_' + str(i + 1) + '_2_pfa_nwk_4nc_delp_out'
        ...
        stream['Parent'] = 'tro_nwk_4nc_' + str(i + 1)
        stream['Type'] = 'pressure'
        stream['Name'] = 'tro_nwk_4nc_' + str(i + 1) + '_2_ser_nwk_4nc_delp_out'
...
############################################################################################################################################################################################################
    ...
    for i in range (0, int(tro_nwk_steps)):   
        term = {}
        term['Parent_unit'] = 'tro_nwk_4nc_' + str(i + 1)
        term['Parent_eqn'] = 'totaluse_tro_nwk_4nc'
