...
def checktype_pfa_nwk_4nc (unit_type):                  ##Input the unit type here
    unit_type = 'utility'
    return unit_type

def pfa_nwk_4nc (pfa_nwk_4nc_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    ...
    ##pfa_nwk_4nc_mdv --- the master decision variables which are used as parameters at this stage 
    ...
    pfa_nwk_steps = pfa_nwk_4nc_mdv['Value'][0]
    pfa_nwk_tf = pfa_nwk_4nc_mdv['Value'][1]
    pfa_nwk_max_flow = pfa_nwk_4nc_mdv['Value'][1] * 0.35               ##This upper bound is needed for the computation of stepwise pressure
...
####################################################################################################################################################################################################        
    ...
    for i in range (0, int(pfa_nwk_steps)):
        ...
        stream = {}                         
        stream['Parent'] = 'pfa_nwk_4nc_' + str(i + 1)
        stream['Type'] = 'flow'
        stream['Name'] = 'pfa_nwk_4nc_' + str(i + 1) + '_flow_in'
        ...
        stream['Parent'] = 'pfa_nwk_4nc_' + str(i + 1)
        stream['Type'] = 'flow'
        stream['Name'] = 'pfa_nwk_4nc_' + str(i + 1) + '_flow_out'
        ...
        stream['Name'] = 'pfa_nwk_4nc_' + str(i + 1) + '_delp_out'
...
############################################################################################################################################################################################################
    ...
    for i in range (0, int(pfa_nwk_steps)):   
        term = {}
        term['Parent_unit'] = 'pfa_nwk_4nc_' + str(i + 1)
        term['Parent_eqn'] = 'totaluse_pfa_nwk_4nc'
