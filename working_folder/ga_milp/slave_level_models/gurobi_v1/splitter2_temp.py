...
def splitter2_temp (sp2_temp_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    ...
    ##Stream 3
    stream3 = {} 
    stream3['Parent'] = 'sp2_temp'                                              ##Copied output to chiller 2 return
    stream3['Type'] = 'balancing_only'
    stream3['Name'] = 'sp2_temp2ch2ret_tout'
    stream3['Layer'] = 'sp2_2_ch2ret_temp'
    ...
    ##Stream 4
    stream4 = {} 
    stream4['Parent'] = 'sp2_temp'                                              ##Copied output to chiller 3 return
    stream4['Type'] = 'balancing_only'
    stream4['Name'] = 'sp2_temp2ch3ret_tout'
    stream4['Layer'] = 'sp2_2_ch3ret_temp'
