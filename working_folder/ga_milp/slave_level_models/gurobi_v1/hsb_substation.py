...
def hsb_substation (hsb_ss_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    ...
    ##Dependent constants 
    hsb_ss_dc = np.zeros((3,1))                                 ##Initialize the list, note the number of constants 
    ...
    hsb_ss = {}
    hsb_ss['Name'] = 'hsb_ss'
    hsb_ss['Variable1'] = 'm_hsbss_perc'                                        ##The percentage of the total flowrate into the system                                                                                                     
    hsb_ss['Variable2'] = 'thsbss_in'                                           ##Temperature of fluid entering the substation                                                              
    hsb_ss['Fmin_v1'] = 0 
    hsb_ss['Fmax_v1'] = 1                                                                                                                    
    ...
    ##Stream 3
    stream3 = {}                                                                
    stream3['Parent'] = 'hsb_ss'                                                ##Flowrate stream entering the substation 
    ...
    ##Stream 4
    stream4 = {}                                                                
    stream4['Parent'] = 'hsb2_ss'                                                ##Flowrate stream exiting the substation 
    ...
    term1['Coeff_v1_1'] = (hsb_substation['hsb_ss_totalflownwk']['value'] * hsb_substation['hsb_ss_cp']['value']) / hsb_substation['hsb_ss_demand']['value']
    term1['Coeff_v2_2'] = 0
    term1['Coeff_v2_1'] = 0
    term1['Coeff_v1v2'] = 0
    term1['Coeff_cst'] = 0
