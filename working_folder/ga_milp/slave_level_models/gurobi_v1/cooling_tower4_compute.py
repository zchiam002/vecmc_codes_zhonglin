...
def cooling_tower4_compute (ct4_dc):
    ...
    mf_water = ct4_dc[0,0] * ct4_dc[1,0]
    T_wetbulb = ct4_dc[2,0]
    ...
    lin_fan_coeff = ct4_dc[12,0] / ct4_dc[10,0]
    
    ##Initiating a matrix to hold the return values 
    
    ct4_calc = np.zeros((5,1))
    
    ct4_calc[0,0] = ma_coeff
    ct4_calc[1,0] = twi_coeff
    ct4_calc[2,0] = matwi_coeff
    ct4_calc[3,0] = cst_term
    ct4_calc[4,0] = lin_fan_coeff 
