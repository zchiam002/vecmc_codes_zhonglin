...
def checktype_pfa_substation_nwk_choice_4 (unit_type):                  ##Input the unit type here
    unit_type = 'utility'
    return unit_type 
    
def pfa_substation_nwk_choice_4 (pfa_ss_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    from nwk_choice_4.pfa_substation_compute_nwk_choice_4 import pfa_substation_compute_nwk_choice_4
    import pandas as pd
    import numpy as np 
    ...
    ##Stream 1
    stream = {}                                                                
    stream['Parent'] = 'pfa_ss'                                                ##Temperature stream entering the substation 
    stream['Type'] = 'temp_chil'
    stream['Name'] = 'pfa_ss_tin'
    stream['Layer'] = 'sp1_temp2pfa'
    stream['Stream_coeff_v1_2'] = 0
    stream['Stream_coeff_v1_1'] = 0
    stream['Stream_coeff_v2_2'] = 0
    stream['Stream_coeff_v2_1'] = (pfa_ss_tinmax - 273.15 - 1)
    ...
    ##Stream 2
    stream = {}                                                                
    stream['Parent'] = 'pfa_ss'                                                ##Flowrate stream entering the substation 
    stream['Type'] = 'flow'
    stream['Name'] = 'pfa_ss_mfin'
    stream['Layer'] = 'chil2distnwk_flow'
    stream['Stream_coeff_v1_2'] = 0
    stream['Stream_coeff_v1_1'] = pfass_totalflownwk 
    stream['Stream_coeff_v2_2'] = 0
    ...
    ##Stream 3
    stream = {}                                                                
    stream['Parent'] = 'pfa_ss'                                                ##Temperture stream exiting the substation 
    stream['Type'] = 'temp_chil'
    stream['Name'] = 'pfa_ss_tout'
    stream['Layer'] = 'ss2sp2_temp'
    stream['Stream_coeff_v1_2'] = 0
    stream['Stream_coeff_v1_1'] = (273.15 + 1) 
    stream['Stream_coeff_v2_2'] = 0
    stream['Stream_coeff_v2_1'] = 0
    stream['Stream_coeff_v1_v2'] = (pfa_ss_tinmax - 273.15 - 1)
    ...
    ##Stream 4
    stream = {}                                                                
    stream['Parent'] = 'pfa_ss'                                                ##Flowrate check
    stream['Type'] = 'balancing_only'
    stream['Name'] = 'pfa_ss_mf_out'
    ...
    eqn['RHS_value'] = 1 / pfa_ss_deltmax
    ...
    ##Term 1
    term = {}
    term['Parent_unit'] = 'pfa_ss'
    term['Parent_eqn'] = 'pfa_ss_tout_max'
    term['Parent_stream'] = 'pfa_ss_tout'                                      ##Only applicable for stream_limit types 
    term['Coefficient'] = 0
