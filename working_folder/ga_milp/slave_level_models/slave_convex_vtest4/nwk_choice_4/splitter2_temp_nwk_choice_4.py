...
def checktype_splitter2_temp_nwk_choice_4 (unit_type):                  ##Input the unit type here
    unit_type = 'utility'
    return unit_type

def splitter2_temp_nwk_choice_4 (sp2_temp_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    import pandas as pd
