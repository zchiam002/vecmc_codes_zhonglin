...
def chiller2 (ch2_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    from nwk_choice_4.chiller2_compute import chiller2_compute
    import pandas as pd
    import numpy as np
    ...
    ch2_1_e['Variable1'] = 'm_perc'                                                                                                      ##Percentage of flowrate from the entire evaporator network 
    ch2_1_e['Variable2'] = 't_out'                                                                                                        ##Chilled water setpoint temperature 
    ch2_1_e['Fmin_v1'] = 0 
    ...
    ch2_1_c['Variable1'] = 'm_perc'                                                                                                      ##Percentage of flowrate from the entire condenser network 
    ch2_1_c['Variable2'] = 't_out'                                                                                                        ##Condenser water setpoint temperature 
    ch2_1_c['Fmin_v1'] = 0 
    ...
    ch2_2_e['Variable1'] = 'm_perc'                                                                                                      ##Percentage of flowrate from the entire evaporator network 
    ch2_2_e['Variable2'] = 't_out'                                                                                                        ##Chilled water setpoint temperature 
    ch2_2_e['Fmin_v1'] = 0 
    ...
    ch2_2_c['Variable1'] = 'm_perc'                                                                                                      ##Percentage of flowrate from the entire condenser network 
    ch2_2_c['Variable2'] = 't_out'                                                                                                        ##Condenser water setpoint temperature 
    ch2_2_c['Fmin_v1'] = 0 
    ...
    ch2_3_e['Variable1'] = 'm_perc'                                                                                                      ##Percentage of flowrate from the entire evaporator network 
    ch2_3_e['Variable2'] = 't_out'                                                                                                        ##Chilled water setpoint temperature 
    ch2_3_e['Fmin_v1'] = 0 
    ...
    ch2_3_c['Variable1'] = 'm_perc'                                                                                                      ##Percentage of flowrate from the entire condenser network 
    ch2_3_c['Variable2'] = 't_out'                                                                                                        ##Condenser water setpoint temperature 
    ch2_3_c['Fmin_v1'] = 0 
    ...
    ch2_4_e['Variable1'] = 'm_perc'                                                                                                      ##Percentage of flowrate from the entire evaporator network 
    ch2_4_e['Variable2'] = 't_out'                                                                                                        ##Chilled water setpoint temperature 
    ch2_4_e['Fmin_v1'] = 0 
    ...
    ch2_4_c['Variable1'] = 'm_perc'                                                                                                      ##Percentage of flowrate from the entire condenser network 
    ch2_4_c['Variable2'] = 't_out'                                                                                                        ##Condenser water setpoint temperature 
    ch2_4_c['Fmin_v1'] = 0 
