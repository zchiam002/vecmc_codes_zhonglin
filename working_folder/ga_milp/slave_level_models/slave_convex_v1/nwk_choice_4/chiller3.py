...
def chiller3 (ch3_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    from nwk_choice_4.chiller3_compute import chiller3_compute
    import pandas as pd
    import numpy as np
    ...
    ch3_1_e['Variable1'] = 'm_perc'                                                                                                      ##Percentage of flowrate from the entire evaporator network 
    ch3_1_e['Variable2'] = 't_out'                                                                                                        ##Chilled water setpoint temperature 
    ch3_1_e['Fmin_v1'] = 0 
    ...
    ch3_1_c['Variable1'] = 'm_perc'                                                                                                      ##Percentage of flowrate from the entire condenser network 
    ch3_1_c['Variable2'] = 't_out'                                                                                                        ##Condenser water setpoint temperature 
    ch3_1_c['Fmin_v1'] = 0 
    ...
    ch3_2_e['Variable1'] = 'm_perc'                                                                                                      ##Percentage of flowrate from the entire evaporator network 
    ch3_2_e['Variable2'] = 't_out'                                                                                                        ##Chilled water setpoint temperature 
    ch3_2_e['Fmin_v1'] = 0 
    ...
    ch3_2_c['Variable1'] = 'm_perc'                                                                                                      ##Percentage of flowrate from the entire condenser network 
    ch3_2_c['Variable2'] = 't_out'                                                                                                        ##Condenser water setpoint temperature 
    ch3_2_c['Fmin_v1'] = 0 
    ...
    ch3_3_e['Variable1'] = 'm_perc'                                                                                                      ##Percentage of flowrate from the entire evaporator network 
    ch3_3_e['Variable2'] = 't_out'                                                                                                        ##Chilled water setpoint temperature 
    ch3_3_e['Fmin_v1'] = 0 
    ...
    ch3_3_c['Variable1'] = 'm_perc'                                                                                                      ##Percentage of flowrate from the entire condenser network 
    ch3_3_c['Variable2'] = 't_out'                                                                                                        ##Condenser water setpoint temperature 
    ch3_3_c['Fmin_v1'] = 0 
    ...
    ch3_4_e['Variable1'] = 'm_perc'                                                                                                      ##Percentage of flowrate from the entire evaporator network 
    ch3_4_e['Variable2'] = 't_out'                                                                                                        ##Chilled water setpoint temperature 
    ch3_4_e['Fmin_v1'] = 0 
    ...
    ch3_4_c['Variable1'] = 'm_perc'                                                                                                      ##Percentage of flowrate from the entire condenser network 
    ch3_4_c['Variable2'] = 't_out'                                                                                                        ##Condenser water setpoint temperature 
    ch3_4_c['Fmin_v1'] = 0 
