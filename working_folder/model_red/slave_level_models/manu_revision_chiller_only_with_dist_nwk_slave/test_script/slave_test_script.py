...
def slave_test_script(dt, ah, t_evap_ret, t_e_flow, cond_flow, ps, bp):
...
#This is for extracting the optimal results from GA    
    for i in range (0, 1):
        ...
        obj_value1, difference, results1 = slave_test_script(dt, ah, t_evap_ret1, t_e_flow, cond_flow, ps, bp)
