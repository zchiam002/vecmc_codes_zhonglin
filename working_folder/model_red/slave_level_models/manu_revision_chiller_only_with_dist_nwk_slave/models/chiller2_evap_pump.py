...
def chiller2_evap_pump (ch2_ep_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    ...
    ##ch2_ep_mdv --- the master decision variables which are used as parameters at this stage 
    ...
    ch2_ep_steps = ch2_ep_mdv['Value'][0]
    ...
    ch2_ep_p_look_up_table_loc = 'C:\\Optimization_zlc\\master_level_models\\manu_revision_chiller_only_with_dist_nwk_master\\look_up_tables\\'      ##Distribution pump look up table location 
