...
def checktype_gv2_substation (unit_type):                  ##Input the unit type here
    unit_type = 'utility'
    return unit_type 
...
def gv2_substation (gv2_ss_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    ...
    gv2_ss_demand = gv2_ss_mdv['Value'][0]
    gv2_ss_totalflownwk = gv2_ss_mdv['Value'][1]
...
############################################################################################################################################################################################################
    ...
    ##Stream 4
    stream = {}                                                                
    stream['Parent'] = 'gv2_ss'                                                ##Flowrate out to the distribution pump
    stream['Type'] = 'flow'
    stream['Name'] = 'gv2_ss_flow_out'
