...
def checktype_chiller_evap_flow_consol_nwk_choice_4 (unit_type):                  ##Input the unit type here
    unit_type = 'process'
    return unit_type
    
def chiller_evap_flow_consol_nwk_choice_4 (ch_e_f_c_mdv, processlist, streams, cons_eqns, cons_eqns_terms):
    import pandas as pd
