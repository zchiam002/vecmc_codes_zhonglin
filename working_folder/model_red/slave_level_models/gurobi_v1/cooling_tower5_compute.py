...
def cooling_tower5_compute (ct5_dc):
    ...
    mf_water = ct5_dc[0,0] * ct5_dc[1,0]
    T_wetbulb = ct5_dc[2,0]
    ...
    lin_fan_coeff = ct5_dc[12,0] / ct5_dc[10,0]
    
    ##Initiating a matrix to hold the return values 
    
    ct5_calc = np.zeros((5,1))
    
    ct5_calc[0,0] = ma_coeff
    ct5_calc[1,0] = twi_coeff
    ct5_calc[2,0] = matwi_coeff
    ct5_calc[3,0] = cst_term
    ct5_calc[4,0] = lin_fan_coeff 
