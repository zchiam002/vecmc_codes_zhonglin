...
def cooling_tower2_compute (ct2_dc):
    ...
    mf_water = ct2_dc[0,0] * ct2_dc[1,0]
    T_wetbulb = ct2_dc[2,0]
    ...
    lin_fan_coeff = ct2_dc[12,0] / ct2_dc[10,0]
    
    ##Initiating a matrix to hold the return values 
    
    ct2_calc = np.zeros((5,1))
    
    ct2_calc[0,0] = ma_coeff
    ct2_calc[1,0] = twi_coeff
    ct2_calc[2,0] = matwi_coeff
    ct2_calc[3,0] = cst_term
    ct2_calc[4,0] = lin_fan_coeff 
