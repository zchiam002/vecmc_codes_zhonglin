...
def chiller2_evap_nwk (ch2_e_nwk_dc):
    ...
    sys_delp1 = ch2_e_nwk_dc[1,0]*pow(sys_flow1 ,1.852) + ch2_e_nwk_dc[2,0]*pow(ch2_e_nwk_dc[3,0] ,1.852)
    sys_delp2 = ch2_e_nwk_dc[1,0]*pow(sys_flow2 ,1.852) + ch2_e_nwk_dc[2,0]*pow(ch2_e_nwk_dc[3,0] ,1.852)
    sys_delp3 = ch2_e_nwk_dc[1,0]*pow(sys_flow3 ,1.852) + ch2_e_nwk_dc[2,0]*pow(ch2_e_nwk_dc[3,0] ,1.852)
    sys_delp4 = ch2_e_nwk_dc[1,0]*pow(sys_flow4 ,1.852) + ch2_e_nwk_dc[2,0]*pow(ch2_e_nwk_dc[3,0] ,1.852)
    sys_delp5 = ch2_e_nwk_dc[1,0]*pow(sys_flow5 ,1.852) + ch2_e_nwk_dc[2,0]*pow(ch2_e_nwk_dc[3,0] ,1.852)
