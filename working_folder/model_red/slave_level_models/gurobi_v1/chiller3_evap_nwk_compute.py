...
def chiller3_evap_nwk (ch3_e_nwk_dc):
    ...
    sys_delp1 = ch3_e_nwk_dc[1,0]*pow(sys_flow1 ,1.852) + ch3_e_nwk_dc[2,0]*pow(ch3_e_nwk_dc[3,0] ,1.852)
    sys_delp2 = ch3_e_nwk_dc[1,0]*pow(sys_flow2 ,1.852) + ch3_e_nwk_dc[2,0]*pow(ch3_e_nwk_dc[3,0] ,1.852)
    sys_delp3 = ch3_e_nwk_dc[1,0]*pow(sys_flow3 ,1.852) + ch3_e_nwk_dc[2,0]*pow(ch3_e_nwk_dc[3,0] ,1.852)
    sys_delp4 = ch3_e_nwk_dc[1,0]*pow(sys_flow4 ,1.852) + ch3_e_nwk_dc[2,0]*pow(ch3_e_nwk_dc[3,0] ,1.852)
    sys_delp5 = ch3_e_nwk_dc[1,0]*pow(sys_flow5 ,1.852) + ch3_e_nwk_dc[2,0]*pow(ch3_e_nwk_dc[3,0] ,1.852)
