...
def cvx_prog_run_nwk_4(parallel_thread_num, bilinear_pieces, solver_choice):
    ...
    slave_models_location = 'C:\\Optimization_zlc\\slave_level_models\\slave_convex_vtest4\\nwk_choice_4\\'
    ...
    ##File 2
    inputmodel = pd.DataFrame(data = ['chiller2_nwk_choice_4'], columns = ['Filename'])                      ##Chiller 1 model 
    files = files.append(inputmodel, ignore_index=True)
    ...
    ##File 4
    inputmodel = pd.DataFrame(data = ['hsb_substation_nwk_choice_4'], columns = ['Filename'])                ##gv2_substation 
    files = files.append(inputmodel, ignore_index=True)   
    
    ##File 5
    inputmodel = pd.DataFrame(data = ['pfa_substation_nwk_choice_4'], columns = ['Filename'])                ##gv2_substation 
    files = files.append(inputmodel, ignore_index=True)   
    
    ##File 6
    inputmodel = pd.DataFrame(data = ['chiller_ret_nwk_choice_4'], columns = ['Filename'])               
    files = files.append(inputmodel, ignore_index=True)        
    
    ##File 7
    inputmodel = pd.DataFrame(data = ['chiller_evap_flow_consol_nwk_choice_4'], columns = ['Filename'])              
    files = files.append(inputmodel, ignore_index=True)   

    ##File 8
    inputmodel = pd.DataFrame(data = ['layers_nwk_choice_4'], columns = ['Filename'])              
    files = files.append(inputmodel, ignore_index=True)   
    
    ##File 9
    inputmodel = pd.DataFrame(data = ['cp_network_nwk_choice_4'], columns = ['Filename'])              
    files = files.append(inputmodel, ignore_index=True)   
    
    ##File 10
    inputmodel = pd.DataFrame(data = ['splitter1_temp_nwk_choice_4'], columns = ['Filename'])               
    files = files.append(inputmodel, ignore_index=True)   

    ##File 11
    inputmodel = pd.DataFrame(data = ['splitter2_temp_nwk_choice_4'], columns = ['Filename'])             
    files = files.append(inputmodel, ignore_index=True)   
