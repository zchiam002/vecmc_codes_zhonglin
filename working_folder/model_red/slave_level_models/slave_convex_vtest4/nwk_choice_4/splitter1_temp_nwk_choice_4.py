...
def checktype_splitter1_temp_nwk_choice_4 (unit_type):                  ##Input the unit type here
    unit_type = 'utility'
    return unit_type

def splitter1_temp_nwk_choice_4 (sp1_temp_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    import pandas as pd
    ...
    ##Stream 5
    stream5 = {}                                                                ##Copied output to pfa substation 
    stream5['Parent'] = 'sp1_temp'
    stream5['Type'] = 'temp_chil'
    stream5['Name'] = 'sp1_temp2pfa_tout'
    stream5['Layer'] = 'sp1_temp2pfa'
    stream5['Stream_coeff_v1_2'] = 0
    stream5['Stream_coeff_v1_1'] = 30
    stream5['Stream_coeff_v2_2'] = 0
    stream5['Stream_coeff_v2_1'] = 0
    stream5['Stream_coeff_v1_v2'] = 0
    stream5['Stream_coeff_cst'] = 273.15
    stream5['InOut'] = 'out'
