...
def checktype_chiller3_evap_nwk_4nc (unit_type):                  ##Input the unit type here
    unit_type = 'utility'
    return unit_type

def chiller3_evap_nwk_4nc (ch3_enwk_4nc_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    from chiller3_evap_nwk_4nc_compute import chiller3_evap_nwk_4nc_compute
    import pandas as pd
    import numpy as np
    ...
    ##ch3_enwk_4nc_mdv --- the master decision variables which are used as parameters at this stage 
    ...
    ch3_enwk_steps = ch3_enwk_4nc_mdv['Value'][0]
    ch3_enwk_tf = ch3_enwk_4nc_mdv['Value'][1]
    ...
    ch3_enwk_calc = chiller3_evap_nwk_4nc_compute(ch3_enwk_dc)
...
####################################################################################################################################################################################################        
    ...
    for i in range (0, int(ch3_enwk_steps)):
        ...
        stream = {}                         
        stream['Parent'] = 'ch3_enwk_4nc_' + str(i + 1)
        stream['Type'] = 'flow'
        stream['Name'] = 'ch3_enwk_4nc_' + str(i + 1) + '_flow_in'
        ...
        stream['Parent'] = 'ch3_enwk_4nc_' + str(i + 1)
        stream['Type'] = 'flow'
        stream['Name'] = 'ch3_enwk_4nc_' + str(i + 1) + '_flow_out'
        ...
        stream['Name'] = 'ch3_enwk_4nc_' + str(i + 1) + '_delp_out'
...
############################################################################################################################################################################################################
    ...
    eqn = {}
    eqn['Name'] = 'totaluse_ch3_enwk_4nc'
    ...
    for i in range (0, int(ch3_enwk_steps)):   
        term = {}
        term['Parent_unit'] = 'ch3_enwk_4nc_' + str(i + 1)
        term['Parent_eqn'] = 'totaluse_ch3_enwk_4nc'
