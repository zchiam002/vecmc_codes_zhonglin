...
def chiller1_cond_nwk_compute (ch1_c_nwk_dc):
    ...
    sys_delp1 = ch1_c_nwk_dc[1,0]*pow(sys_flow1 ,1.852) + ch1_c_nwk_dc[2,0]*pow(ch1_c_nwk_dc[0,0] ,1.852)
    sys_delp2 = ch1_c_nwk_dc[1,0]*pow(sys_flow2 ,1.852) + ch1_c_nwk_dc[2,0]*pow(ch1_c_nwk_dc[0,0] ,1.852)
    sys_delp3 = ch1_c_nwk_dc[1,0]*pow(sys_flow3 ,1.852) + ch1_c_nwk_dc[2,0]*pow(ch1_c_nwk_dc[0,0] ,1.852)
    sys_delp4 = ch1_c_nwk_dc[1,0]*pow(sys_flow4 ,1.852) + ch1_c_nwk_dc[2,0]*pow(ch1_c_nwk_dc[0,0] ,1.852)
    sys_delp5 = ch1_c_nwk_dc[1,0]*pow(sys_flow5 ,1.852) + ch1_c_nwk_dc[2,0]*pow(ch1_c_nwk_dc[0,0] ,1.852)
