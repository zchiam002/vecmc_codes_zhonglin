...
def fir_substation (fir_ss_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    from nwk_choice_4.fir_substation_compute import fir_substation_compute
    import pandas as pd
    import numpy as np 
    ...
    ##Dependent constants 
    fir_ss_dc = np.zeros((5,1))                                 ##Initialize the list, note the number of constants 
    ...
    ##7 
    fir_ss_constraint_eqn_coeff = {}
    fir_ss_constraint_eqn_coeff['value'] = fir_ss_calc[1,0]     ##The constraint coefficient term to ensure that the delta t of the hx on the cold side does not exceed max delta t
    fir_ss_constraint_eqn_coeff['units'] = '-'
    fir_ss_constraint_eqn_coeff['status'] = 'calc'
    fir_ss_constraint_eqn_coeff['fir_ss_constraint_eqn_coeff'] = fir_ss_constraint_eqn_coeff  
    ...
    fir_ss = {}
    fir_ss['Name'] = 'fir_ss'
    fir_ss['Variable1'] = 'm_perc'                                        ##The percentage of the total flowrate into the system                                                                                                     
    fir_ss['Variable2'] = 't_in'                                           ##Temperature of fluid entering the substation                                                              
    fir_ss['Fmin_v1'] = 0 
    fir_ss['Fmax_v1'] = 1                                                                                                                    
    ...
    ##Stream 3
    stream3 = {}                                                                
    stream3['Parent'] = 'fir_ss'                                                ##Temperature stream exiting the substation 
    ...
    term1['Coeff_v1_1'] = fir_ss_constraint_eqn_coeff['fir_ss_constraint_eqn_coeff']['value']
    term1['Coeff_v2_2'] = 0
    term1['Coeff_v2_1'] = 0
    term1['Coeff_v1v2'] = 0
    term1['Coeff_cst'] = 0
