## This is the interface to access GLPK



##Creating the batch file 
def glpk_interface(solver_dir, input_dir, output_dir, file_format):
    import subprocess
    import os
    
    command = solver_dir + ' ' + file_format + ' ' + input_dir + ' -o ' + output_dir 
