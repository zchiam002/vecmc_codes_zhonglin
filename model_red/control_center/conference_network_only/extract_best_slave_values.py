...
def process_extract_best_slave ():
    ...
    sol_file_loc = 'C:\\Optimization_zlc\\control_center\\2_chiller_3_demand\\ga_results_current_store\\4_run_test\\best_obj_per_gen.csv'
    sol_file = np.genfromtxt(sol_file_loc, delimiter=',')
    dim_sol_file = sol_file.shape
    
    main_working_folder_loc = 'C:\\Optimization_zlc\\control_center\\2_chiller_3_demand\\'
    ...
    if parallel_process == 'no':
        ...
        all_var_values.to_csv('C:\\Optimization_zlc\\control_center\\2_chiller_3_demand\\ga_results_current_store\\4_run_test\\best_performing_all.csv')
...
def ga_scsd_run_ea_extract_values (variables, iteration):
    ...
    sys.path.append('C:\\Optimization_zlc\\control_center\\2_chiller_3_demand\\')
...
def execute_parallel_worker_function (iteration_number):
    ...
    data_loc = 'C:\\Optimization_zlc\\control_center\\2_chiller_3_demand\\ga_results_current_store\\4_run_test\\best_obj_per_gen.csv'
