...
def chiller_gnu_stepwise_cop_lprelax (reg_cst, qc_coeff, Tin_evap, Tout_evap, Tin_cond, mevap, mcond, Qe_max, steps, bilinear_pieces, mevap_t, mcond_t, twb):
    import sys 
    sys.path.append('C:\\Optimization_zlc\\simulation_models\\ecoenergies_models\\sub_scripts\\')
    sys.path.append('C:\Optimization_zlc\glpk_handlers\simulation_output_extractor\\')
