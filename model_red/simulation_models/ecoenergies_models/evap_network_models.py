...
def evap_nwk_org (chiller_input, cp_dist_nwk_split):
    import sys
    ...
    evap_pump_1_elect = [0, 0, 0.0087224764, 4.0804382340]   ##Listed in terms of x3, x2, x and cst coeff
    evap_pump_2_elect = [0, 0, 0.0209871245, 20.3919751419]
    evap_pump_3_elect = [0, 0, 0.0209871245, 20.3919751419]

    ##Flow limits 
    ch1_evap_nwk_flow_limit = 3200
    ch2_evap_nwk_flow_limit = 3200   
    ch3_evap_nwk_flow_limit = 3200
...
def evap_nwk_piecewise_pressure (chiller_input, cp_dist_nwk_split, steps):
    ...
    evap_pump_2_elect = [0, 0, 0.0209871245, 20.3919751419]
    evap_pump_3_elect = [0, 0, 0.0209871245, 20.3919751419]
    ##Determine the hard limits of flowrate for each system, lowest delta p case
    ch1_evap_nwk_flow_limit = 250
    ch2_evap_nwk_flow_limit = 850
    ch3_evap_nwk_flow_limit = 850
...
def evap_nwk_piecewise_pressure_reg_pumpnwk (chiller_input, cp_dist_nwk_split, steps):
...
def evap_nwk_piecewise_pressure_reg_pumpnwk_bilinear_temp (chiller_input, cp_dist_nwk_split, steps, tevap_in, bilinear_pieces):
