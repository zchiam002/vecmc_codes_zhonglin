...
def checktype_chiller2_nwk_choice_4 (unit_type):                  ##Input the unit type here
    unit_type = 'utility'
    return unit_type

def chiller2_nwk_choice_4 (ch2_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    from chiller2_compute_nwk_choice_4 import chiller2_compute_nwk_choice_4
    import pandas as pd
    import numpy as np
    ...
    ch2_steps = ch2_mdv['Value'][4]                        ##The number of piecewise linear pieces
    ...
    ch2_dc[8,0] = ch2_tcnwkflow
    ch2_dc[9,0] = ch2_steps
    
    ch2_ret_vals = chiller2_compute_nwk_choice_4(ch2_dc)
