...
def checktype_hsb_substation_nwk_choice_4 (unit_type):                  ##Input the unit type here
    unit_type = 'utility'
    return unit_type 
    
def hsb_substation_nwk_choice_4 (hsb_ss_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    from nwk_choice_4.hsb_substation_compute_nwk_choice_4 import hsb_substation_compute_nwk_choice_4
    import pandas as pd
    import numpy as np 
    ...
    stream['Stream_coeff_v1_2'] = 0
    stream['Stream_coeff_v1_1'] = hsbss_totalflownwk 
    stream['Stream_coeff_v2_2'] = 0
    ...
    ##Stream 4
    stream = {}                                                                
    stream['Parent'] = 'hsb_ss'                                                ##Flowrate check
    stream['Type'] = 'balancing_only'
    stream['Name'] = 'hsb_ss_mf_out'
    ...
    eqn['RHS_value'] = 1 / hsb_ss_deltmax
    ...
    term['Parent_stream'] = 'hsb_ss_tout'                                      ##Only applicable for stream_limit types 
    term['Coefficient'] = 0
