...
def cvx_prog_run_4nc(parallel_thread_num, bilinear_pieces, solver_choice):
    ...
    slave_models_location = 'C:\\Optimization_zlc\\slave_level_models\\paper_qe_testcase_slave_convex\\models\\nwk_choice4\\'
    package_name = 'nwk_choice4'
    ...
    inputmodel = pd.DataFrame(data = ['splitter2_temp_4nc'], columns = ['Filename'])                
    files = files.append(inputmodel, ignore_index=True)     
    ...
    ##Chiller condenser side modules      
    inputmodel = pd.DataFrame(data = ['chiller1_cond_4nc'], columns = ['Filename'])                
    files = files.append(inputmodel, ignore_index=True) 

    inputmodel = pd.DataFrame(data = ['chiller2_cond_4nc'], columns = ['Filename'])                
    files = files.append(inputmodel, ignore_index=True) 

    inputmodel = pd.DataFrame(data = ['chiller3_cond_4nc'], columns = ['Filename'])                
    files = files.append(inputmodel, ignore_index=True) 
    
    
    ##Condenser outlet temperature consolidation
#    inputmodel = pd.DataFrame(data = ['splitter3_temp_4nc'], columns = ['Filename'])                
#    files = files.append(inputmodel, ignore_index=True) 

 
    ##Condenser network modules 
    inputmodel = pd.DataFrame(data = ['chiller1_cond_nwk_4nc'], columns = ['Filename'])                
    files = files.append(inputmodel, ignore_index=True) 

    inputmodel = pd.DataFrame(data = ['chiller2_cond_nwk_4nc'], columns = ['Filename'])                
    files = files.append(inputmodel, ignore_index=True) 

    inputmodel = pd.DataFrame(data = ['chiller3_cond_nwk_4nc'], columns = ['Filename'])                
    files = files.append(inputmodel, ignore_index=True) 
    
   
    ##Condenser pump modules 
    inputmodel = pd.DataFrame(data = ['chiller1_cond_pump_4nc'], columns = ['Filename'])                
    files = files.append(inputmodel, ignore_index=True) 

    inputmodel = pd.DataFrame(data = ['chiller2_cond_pump_4nc'], columns = ['Filename'])                
    files = files.append(inputmodel, ignore_index=True) 

    inputmodel = pd.DataFrame(data = ['chiller3_cond_pump_4nc'], columns = ['Filename'])                
    files = files.append(inputmodel, ignore_index=True)  
    
    
    ##Cooling tower modules 
#    inputmodel = pd.DataFrame(data = ['cooling_tower1_4nc'], columns = ['Filename'])                
#    files = files.append(inputmodel, ignore_index=True)      
#    
#    inputmodel = pd.DataFrame(data = ['cooling_tower2_4nc'], columns = ['Filename'])                
#    files = files.append(inputmodel, ignore_index=True)    
#
#    inputmodel = pd.DataFrame(data = ['cooling_tower3_4nc'], columns = ['Filename'])                
#    files = files.append(inputmodel, ignore_index=True)    
#
#    inputmodel = pd.DataFrame(data = ['cooling_tower4_4nc'], columns = ['Filename'])                
#    files = files.append(inputmodel, ignore_index=True)    
#
#    inputmodel = pd.DataFrame(data = ['cooling_tower5_4nc'], columns = ['Filename'])                
#    files = files.append(inputmodel, ignore_index=True)   
    
    
    ##Cooling tower temperature outlet consolidation unit
#    inputmodel = pd.DataFrame(data = ['splitter4_temp_4nc'], columns = ['Filename'])                
#    files = files.append(inputmodel, ignore_index=True) 
    
    
    ##Condenser process modules 
    inputmodel = pd.DataFrame(data = ['chiller_cond_flow_consol_4nc'], columns = ['Filename'])                
    files = files.append(inputmodel, ignore_index=True)     
    
#    inputmodel = pd.DataFrame(data = ['chiller_ret_cond_4nc'], columns = ['Filename'])                
#    files = files.append(inputmodel, ignore_index=True)   
