...
sys.path.append('C:\\Optimization_zlc\\slave_level_models\\slave_convex_vtest2\\')
...
mdv_file_loc = 'C:\\Optimization_zlc\\input_data\\master_decision_vtest1\\master_decision_variables.csv'
...
for i in range (0, time_steps_test):
    ...
    convert_mdv_to_slave_param(parallel_thread_num, mdv, var_input, temp_weather_rec, temp_demand_rec, nwk_choice, piecewise_steps)
