...
def checktype_gv2_substation_nwk_choice_4 (unit_type):                  ##Input the unit type here
    unit_type = 'utility'
    return unit_type 
    
def gv2_substation_nwk_choice_4 (gv2_ss_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    from nwk_choice_4.gv2_substation_compute_nwk_choice_4 import gv2_substation_compute_nwk_choice_4
    import pandas as pd
    import numpy as np 
    ...
    ##Stream 1
    stream = {}                                                                
    stream['Parent'] = 'gv2_ss'                                                ##Temperature stream entering the substation 
    stream['Type'] = 'temp_chil'
    stream['Name'] = 'gv2_ss_tin'
    stream['Layer'] = 'sp1_temp2gv2'
    stream['Stream_coeff_v1_2'] = 0
    stream['Stream_coeff_v1_1'] = 0
    stream['Stream_coeff_v2_2'] = 0
    stream['Stream_coeff_v2_1'] = (gv2_ss_tinmax - 273.15 - 1)
    ...
    ##Stream 2
    stream = {}                                                                
    stream['Parent'] = 'gv2_ss'                                                ##Flowrate stream entering the substation 
    stream['Type'] = 'flow'
    stream['Name'] = 'gv2_ss_mfin'
    stream['Layer'] = 'chil2distnwk_flow'
    stream['Stream_coeff_v1_2'] = 0
    stream['Stream_coeff_v1_1'] = gv2ss_totalflownwk 
    stream['Stream_coeff_v2_2'] = 0
    ...
    stream['Stream_coeff_v2_2'] = 0
    stream['Stream_coeff_v2_1'] = 0
    stream['Stream_coeff_v1_v2'] = (gv2_ss_tinmax - 273.15 - 1)
    stream['Stream_coeff_cst'] = gv2_ss_temp_exit_cst
    stream['InOut'] = 'out'
    print(stream['Stream_coeff_v1_1'], stream['Stream_coeff_v1_v2'], stream['Stream_coeff_cst'])
    ...
    ##Stream 4
    stream = {}                                                                
    stream['Parent'] = 'gv2_ss'                                                ##Flowrate check
    stream['Type'] = 'balancing_only'
    stream['Name'] = 'gv2_ss_mf_out'
    ...
    eqn['RHS_value'] = 1 / gv2_ss_deltmax
    ...
    ##Term 1
    term = {}
    term['Parent_unit'] = 'gv2_ss'
    term['Parent_eqn'] = 'gv2_ss_tout_max'
    term['Parent_stream'] = 'gv2_ss_tout'                                      ##Only applicable for stream_limit types 
    term['Coefficient'] = 0
