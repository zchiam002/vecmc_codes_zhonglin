...
def cp_network (cp_nwk_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    from cp_network_compute import cp_network_compute
    import pandas as pd
    import numpy as np 
