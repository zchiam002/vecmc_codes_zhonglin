##Interface for quadratic optimization with gurobi
...
##The process is as follows 
    ...
    ##Quadratic programming phase 
        ##A master list
        ##Models 
        ##Script to arrange into standard form for the Gurobi solver 
...
import sys 
sys.path.append('C:\\Optimization_zlc\\gurobi_handlers\\')
from gurobi_backend import gurobi_backend
import pandas as pd 
...
##File 34
inputmodel = pd.DataFrame(data = ['dist_pump'], columns = ['Filename'])                     ##The selected distribution pump which is selected to serve the distribution
...
#obj_value, util = 
gurobi_backend(files, multi_time, obj_func)
