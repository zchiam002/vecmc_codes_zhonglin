...
def slave_test_script():
    ...
    demand_ah = 21
    demand_file_loc = 'C:\\Optimization_zlc\\input_data\\3_chiller_1_demand_12ts_3_period_input_data\\high_load\\high_demand_' + str(demand_ah) + '.csv'
    
    ##Getting information for condenser inlet temperature 
    temp_loc = 'C:\\Optimization_zlc\\input_data\\conference_chiller_only_input_data\\high_load\\high_demand_weather.csv'
    ...
    v0 = 282.12482404692   ##Chiller evap return temperature  
    v1 = 331.703557384928    ##Total_evaporator_flowrate     
    v2 = temp_wb['T_WB'][demand_ah] +273.15 + 5      ##Chiller condenser entry temperature, since the cooling tower models were not included, this is fixed
