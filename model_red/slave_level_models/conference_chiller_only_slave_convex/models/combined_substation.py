...
def combined_substation (cb_ss_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    from combined_substation_compute import combined_substation_compute
    import pandas as pd
    import numpy as np 
    
    ##Model description 
    ##This is the cb substation model, it treats the demand as a parameter and outputs a tout
    
    ##Legend of input variables 
    
    ##cbss_demand          --- the cooling load at the substation (kWh)
    ##cbss_totalflownwk    --- the total flowrate through parallel systems to this substation (m3/h) 
    
    ##Defining inputs 
    
    ##Processing list of master decision variables/inputs as parameters 
    cbss_demand = cb_ss_mdv['Value'][0]
    cbss_totalflownwk = cb_ss_mdv['Value'][1]
    cbss_delt_max = cb_ss_mdv['Value'][2]
    ...
    cb_ss_tinmax  = 273.15 + 5       ##The maximum temperature of water entering the substation 
    cb_ss_deltmax  = cb_ss_mdv['Value'][2]              ##The maximum delta t of the substation on the cold side  
    cb_ss_cp = 4.2                   ##The heat capacity of water 
    ...
    cb_ss_dc[4,0] = cbss_delt_max

    cb_ss_calc = combined_substation_compute(cb_ss_dc)
    
    cb_ss_temp_exit_cst = cb_ss_calc[0,0]            ##The constant term for the exit temperature stream 
    cb_ss_constraint_eqn_coeff = cb_ss_calc[1,0]     ##The constraint coefficient term to ensure that the delta t of the hx on the cold side does not exceed max delta t
    ...
    ##Stream 1
    stream = {}                                                                
    stream['Parent'] = 'cb_ss'                                                ##Temperature stream entering the substation 
    stream['Type'] = 'temp_chil'
    stream['Name'] = 'cb_ss_tin'
    stream['Layer'] = 'sp1_temp2cb'
    stream['Stream_coeff_v1_2'] = 0
    stream['Stream_coeff_v1_1'] = 0
    stream['Stream_coeff_v2_2'] = 0
    stream['Stream_coeff_v2_1'] = (cb_ss_tinmax - 273.15 - 1)
    ...
    ##Stream 2
    stream = {}                                                                
    stream['Parent'] = 'cb_ss'                                                ##Flowrate stream entering the substation 
    stream['Type'] = 'flow'
    stream['Name'] = 'cb_ss_mfin'
    stream['Layer'] = 'chil2distnwk_flow'
    stream['Stream_coeff_v1_2'] = 0
    stream['Stream_coeff_v1_1'] = cbss_totalflownwk 
    stream['Stream_coeff_v2_2'] = 0
    ...
    ##Stream 3
    stream = {}                                                                
    stream['Parent'] = 'cb_ss'                                                ##Temperture stream exiting the substation 
    stream['Type'] = 'temp_chil'
    stream['Name'] = 'cb_ss_tout'
    stream['Layer'] = 'ss2sp2_temp'
    stream['Stream_coeff_v1_2'] = 0
    stream['Stream_coeff_v1_1'] = (273.15 + 1) 
    stream['Stream_coeff_v2_2'] = 0
    stream['Stream_coeff_v2_1'] = 0
    stream['Stream_coeff_v1_v2'] = (cb_ss_tinmax - 273.15 - 1)
    stream['Stream_coeff_cst'] = cb_ss_temp_exit_cst
    stream['InOut'] = 'out'
    ...
    ##Stream 4
    stream = {}                                                                
    stream['Parent'] = 'cb_ss'                                                ##Flowrate check
    stream['Type'] = 'balancing_only'
    stream['Name'] = 'cb_ss_mf_out'
    ...
    ##Term 1
    term = {}
    term['Parent_unit'] = 'cb_ss'
    term['Parent_eqn'] = 'cb_ss_tout_max'
    term['Parent_stream'] = 'cb_ss_tout'                                      ##Only applicable for stream_limit types 
    term['Coefficient'] = 0
    term['Coeff_v1_2'] = 0                                                     ##Only applicable for stream_limit_modified types 
    term['Coeff_v1_1'] = cb_ss_constraint_eqn_coeff
    term['Coeff_v2_2'] = 0
    term['Coeff_v2_1'] = 0
    term['Coeff_v1_v2'] = 0
    term['Coeff_cst'] = 0
