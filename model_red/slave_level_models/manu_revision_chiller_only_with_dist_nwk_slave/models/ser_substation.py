...
def checktype_ser_substation (unit_type):                  ##Input the unit type here
    unit_type = 'utility'
    return unit_type 
...
def ser_substation (ser_ss_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    ...
    ser_ss_demand = ser_ss_mdv['Value'][0]
    ser_ss_totalflownwk = ser_ss_mdv['Value'][1]
    ...
    ##Stream 1
    stream = {}                                                                
    stream['Parent'] = 'ser_ss'                                                ##Temperature stream entering the substation 
    stream['Type'] = 'temp_chil'
    stream['Name'] = 'ser_ss_tin'
    ...
    ##Stream 2
    stream = {}                                                                
    stream['Parent'] = 'ser_ss'                                                ##Flowrate stream entering the substation 
    stream['Type'] = 'flow'
    stream['Name'] = 'ser_ss_mfin'
    ...
    ##Stream 3
    stream = {}                                                                
    stream['Parent'] = 'ser_ss'                                                ##Temperture stream exiting the substation 
    stream['Type'] = 'temp_chil'
    stream['Name'] = 'ser_ss_tout'
    ...
    ##Stream 4
    stream = {}                                                                
    stream['Parent'] = 'ser_ss'                                                ##Flowrate out to the distribution pump
    stream['Type'] = 'flow'
    stream['Name'] = 'ser_ss_flow_out'
    ...
    ##Term 1
    term = {}
    term['Parent_unit'] = 'ser_ss'
    term['Parent_eqn'] = 'ser_ss_tout_max'
