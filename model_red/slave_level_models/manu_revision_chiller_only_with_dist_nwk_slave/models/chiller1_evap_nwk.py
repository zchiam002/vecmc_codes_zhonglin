...
def chiller1_evap_nwk (ch1_enwk_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    ...
    ##ch1_enwk_mdv --- the master decision variables which are used as parameters at this stage 
    ...
    ch1_enwk_steps = ch1_enwk_mdv['Value'][0]
    ch1_enwk_tf = ch1_enwk_mdv['Value'][1]                  
