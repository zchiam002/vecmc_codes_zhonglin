...
def checktype_chiller3_cond_4nc (unit_type):                  ##Input the unit type here
    unit_type = 'utility'
    return unit_type

def chiller3_cond_4nc (ch3_c_4nc_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):

    import pandas as pd
    import numpy as np
    
    ##This is the condenser side of chiller3_evap_4nc
    ...
    ##ch3_c_4nc_mdv --- the master decision variables which are used as parameters at this stage 
    ...
    ch3_4nc_tcnwkflow = ch3_c_4nc_mdv['Value'][0]
    ch3_4nc_ctin = ch3_c_4nc_mdv['Value'][1]
    
    ##Defined constants 
    ch3_4nc_cp = 4.2
    ch3_4nc_tout_max = 7 + ch3_4nc_ctin
    ch3_4nc_req_flow = 1476
    ch3_4nc_perc = ch3_4nc_req_flow / ch3_4nc_tcnwkflow     
...
#################################################################################################################################################################################################        
    ...
    ud['Fmin_v1'] = 0.99 * ch3_4nc_perc
    ud['Fmax_v1'] = 1.01 * ch3_4nc_perc                                                                             ##Maximum percentage is 100% 
    ud['Fmin_v2'] = 0                                                                                               
    ud['Fmax_v2'] = 1                                                                                               
    ud['Coeff_v1_2'] = 0                                                                                            
    ud['Coeff_v1_1'] = 0             
...
####################################################################################################################################################################################################        
    ...
    stream = {}                         
    stream['Parent'] = 'ch3_4nc_cond'
    stream['Type'] = 'energy_reverse'
    stream['Name'] = 'ch3_4nc_cond_energyin'
    ...
    stream['Stream_coeff_v1_v2'] = (ch3_4nc_tcnwkflow * 998.2 / 3600) * ch3_4nc_cp * (ch3_4nc_tout_max - ch3_4nc_ctin)
    ...
    stream['Name'] = 'ch3_4nc_cond_mfout'
    stream['Layer'] = 'ch3_2_ch3condnwk_flow'
    stream['Stream_coeff_v1_2'] = 0
    stream['Stream_coeff_v1_1'] = ch3_4nc_tcnwkflow 
    stream['Stream_coeff_v2_2'] = 0
    stream['Stream_coeff_v2_1'] = 0
...
#    stream['Name'] = 'ch3_4nc_cond_tout'
#    stream['Layer'] = 'chilcond2sp3_temp'
#    stream['Stream_coeff_v1_2'] = 0
#    stream['Stream_coeff_v1_1'] = ch3_4nc_ctin 
#    stream['Stream_coeff_v2_2'] = 0
#    stream['Stream_coeff_v2_1'] = 0
#    stream['Stream_coeff_v1_v2'] = ch3_4nc_tout_max - ch3_4nc_ctin
#    stream['Stream_coeff_cst'] = 0
#    stream['InOut'] = 'out'
#    
#    streaminput = [stream['Parent'], stream['Type'], stream['Name'], stream['Layer'], stream['Stream_coeff_v1_2'], stream['Stream_coeff_v1_1'], stream['Stream_coeff_v2_2'],
