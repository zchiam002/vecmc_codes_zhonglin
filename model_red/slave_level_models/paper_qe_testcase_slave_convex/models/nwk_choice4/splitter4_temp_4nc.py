...
def checktype_splitter4_temp_4nc (unit_type):                  ##Input the unit type here
    unit_type = 'utility'
    return unit_type

def splitter4_temp_4nc (sp4_temp_4nc_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    import pandas as pd
    ...
    ##Stream 1
    stream = {}                                                                ##This is the input from the cooling towers 
    stream['Parent'] = 'sp4_temp_4nc'
    stream['Type'] = 'temp_chil'
    stream['Name'] = 'sp4_temp_4nc_tin'
    stream['Layer'] = 'ct_2_sp4_temp'
    ...
    ##Stream 2
    stream = {} 
    stream['Parent'] = 'sp4_temp_4nc'                                          ##This is the output to the condenser inlet unit 
    stream['Type'] = 'balancing_only'
    stream['Name'] = 'sp4_temp_4nc_tout'
