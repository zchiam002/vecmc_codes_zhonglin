...
def checktype_cooling_tower3_4nc (unit_type):                  ##Input the unit type here
    unit_type = 'utility'
    return unit_type
    
def cooling_tower3_4nc (ct3_4nc_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    from cooling_tower3_4nc_compute import cooling_tower3_4nc_compute
    import pandas as pd
    import numpy as np
    ...
    ##ct3_4nc_mdv --- the master decision variables which are used as parameters at this stage 
    ...
    ct3_4nc_twb = ct3_4nc_mdv['Value'][0]                                       ##Thermodynamic wetbulb temperature
    ct3_4nc_c0 = ct3_4nc_mdv['Value'][1]                                        ##ma coeff    
    ct3_4nc_c1 = ct3_4nc_mdv['Value'][2]                                        ##twi coeff   
    ct3_4nc_c2 = ct3_4nc_mdv['Value'][3]                                        ##matwi coeff    
    ct3_4nc_c3 = ct3_4nc_mdv['Value'][4]                                        ##cst    
    ct3_4nc_tcnwkflow = ct3_4nc_mdv['Value'][5]                                 ##Total condenser network flow   
    
    ##Defined constants 
    ct3_4nc_num_towers_config = 5
    ct3_4nc_ma_min = 0.05
    ct3_4nc_ma_max = 1
    ct3_4nc_twi_range = 10
    ct3_4nc_max_ma_flow = 369117                                                ##kg/hr of air 
    ct3_4nc_min_approach = 1
    ct3_4nc_elect_max = 22
    ct3_4nc_make_up_water_correct_coeff = 2.3294122
    
    ##Calling a compute file to process dependent values
        ##Placing the values in a numpy array for easy data handling 
    ct3_4nc_dc = np.zeros((11, 1))    
    ct3_4nc_dc[0,0] = ct3_4nc_twb
    ct3_4nc_dc[1,0] = ct3_4nc_twi_range
    ct3_4nc_dc[2,0] = ct3_4nc_min_approach
    ct3_4nc_dc[3,0] = ct3_4nc_make_up_water_correct_coeff     
    ct3_4nc_dc[4,0] = ct3_4nc_tcnwkflow   
    ct3_4nc_dc[5,0] = ct3_4nc_num_towers_config  
    ct3_4nc_dc[6,0] = ct3_4nc_max_ma_flow 
    ct3_4nc_dc[7,0] = ct3_4nc_c0 
    ct3_4nc_dc[8,0] = ct3_4nc_c1 
    ct3_4nc_dc[9,0] = ct3_4nc_c2 
    ct3_4nc_dc[10,0] = ct3_4nc_c3 
    
    ct3_4nc_calc = cooling_tower3_4nc_compute(ct3_4nc_dc)
...
#################################################################################################################################################################################################        
    ...
    ct1['Variable1'] = 'ma'                                                                                                           
    ct1['Variable2'] = 'twi'                                                                                                          
    ct1['Fmin_v1'] = ct3_4nc_ma_min 
    ct1['Fmax_v1'] = ct3_4nc_ma_max                                                                           
    ct1['Fmin_v2'] = 0                                                                                             
    ct1['Fmax_v2'] = 1                                                                       
    ct1['Coeff_v1_2'] = 0                                                                                                            
    ct1['Coeff_v1_1'] = 0   
    ...
    ct1['Cinv_cst'] = 0
    ct1['Power_v1_2'] = 0
    ct1['Power_v1_1'] = ct3_4nc_elect_max
    ct1['Power_v2_2'] = 0
    ct1['Power_v2_1'] = 0
    ct1['Power_v1_v2'] = 0
    ct1['Power_cst'] = 0
    ...
    ##Stream 2
    stream2 = {}                                                                
    stream2['Parent'] = 'ct3_4nc'                                               ##the outlet temperature flow out of the cooling tower as a fraction
    stream2['Type'] = 'temp_chil'
    stream2['Name'] = 'ct3_4nc_tout'
    stream2['Layer'] = 'ct_2_sp4_temp'
    stream2['Stream_coeff_v1_2'] = 0
    stream2['Stream_coeff_v1_1'] = -(ct3_4nc_calc[2,0]) / ct3_4nc_num_towers_config
    stream2['Stream_coeff_v2_2'] = 0
    stream2['Stream_coeff_v2_1'] = ((ct3_4nc_calc[1,0] - ct3_4nc_calc[0,0]) - ct3_4nc_calc[3,0]) / ct3_4nc_num_towers_config 
    stream2['Stream_coeff_v1_v2'] = -(ct3_4nc_calc[4,0]) / ct3_4nc_num_towers_config 
    stream2['Stream_coeff_cst'] = (ct3_4nc_calc[0,0] - ct3_4nc_calc[5,0]) / ct3_4nc_num_towers_config
    stream2['InOut'] = 'out'
...
#    eqn['Name'] = 'ct3_4nc_min_frac_tout'
...
#    cons_eqns = cons_eqns.append(eqninputdf, ignore_index=True)    
    ...
    term = {}
    term['Parent_unit'] = 'ct3_4nc'
    term['Parent_eqn'] = 'totaluse_ct3_4nc'
...
#    term = {}
#    term['Parent_unit'] = 'ct3_4nc'
#    term['Parent_eqn'] = 'ct3_4nc_min_frac_tout'
#    term['Parent_stream'] = '-'                                    ##Only applicable for stream_limit types 
#    term['Coefficient'] = 0
#    term['Coeff_v1_2'] = 0                                         ##Only applicable for stream_limit_modified types 
#    term['Coeff_v1_1'] = -(ct3_4nc_calc[2,0]) / ct3_4nc_num_towers_config
#    term['Coeff_v2_2'] = 0
#    term['Coeff_v2_1'] = ((ct3_4nc_calc[1,0] - ct3_4nc_calc[0,0]) - ct3_4nc_calc[3,0]) / ct3_4nc_num_towers_config
#    term['Coeff_v1_v2'] = -(ct3_4nc_calc[4,0]) / ct3_4nc_num_towers_config
#    term['Coeff_cst'] = ((ct3_4nc_calc[0,0] - ct3_4nc_calc[5,0]) / ct3_4nc_num_towers_config) - ct3_4nc_calc[6,0]
#
#    terminput = [term['Parent_unit'], term['Parent_eqn'], term['Parent_stream'], term['Coefficient'], term['Coeff_v1_2'],
#                 term['Coeff_v1_1'], term['Coeff_v2_2'], term['Coeff_v2_1'], term['Coeff_v1_v2'], term['Coeff_cst']]
#    terminputdf = pd.DataFrame(data = [terminput], columns = ['Parent_unit', 'Parent_eqn', 'Parent_stream', 'Coefficient', 
