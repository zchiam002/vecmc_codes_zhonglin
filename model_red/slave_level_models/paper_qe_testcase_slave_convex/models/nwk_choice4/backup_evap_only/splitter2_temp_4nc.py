...
def checktype_splitter2_temp_4nc (unit_type):                  ##Input the unit type here
    unit_type = 'utility'
    return unit_type

def splitter2_temp_4nc (sp2_4nc_temp_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    import pandas as pd
    ...
    ud = {}
    ud['Name'] = 'sp2_temp_4nc'
    ud['Variable1'] = 't_inout'                                                                                                     
    ud['Variable2'] = '-'                                                                                                       
    ud['Fmin_v1'] = 0 
    ud['Fmax_v1'] = 1                                                                                                              
    ud['Fmin_v2'] = 0                                                                                                        
    ...
    ##Stream 1
    stream = {}                                                                
    stream['Parent'] = 'sp2_temp_4nc'
    stream['Type'] = 'temp_chil'
    stream['Name'] = 'ss2sp2_tin'
    ...
    stream['Name'] = 'sp2_temp2ch1ret_tout'
