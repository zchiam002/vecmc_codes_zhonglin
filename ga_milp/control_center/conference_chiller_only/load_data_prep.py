...
def define_load_periods():
    ...
    weather_data = pd.read_csv('C:\\Optimization_zlc\\input_data\\paper_qe_testcase_input_data\\2016_demand\\weather_data_raw.csv')
    client_load_data = pd.read_csv('C:\\Optimization_zlc\\input_data\\paper_qe_testcase_input_data\\2016_demand\\client_load_data.csv')
    
    ##Determining the savefile locations 
    hl_loc = 'C:\\Optimization_zlc\\input_data\\paper_qe_testcase_input_data\\high_load\\'
    ml_loc = 'C:\\Optimization_zlc\\input_data\\paper_qe_testcase_input_data\\mid_load\\'
    ll_loc = 'C:\\Optimization_zlc\\input_data\\paper_qe_testcase_input_data\\low_load\\'
    note_loc = 'C:\\Optimization_zlc\\input_data\\paper_qe_testcase_input_data\\'
