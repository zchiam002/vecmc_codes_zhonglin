...
def save_function (ret_dataframes, layerslist, utilitylist, processlist, streams, cons_eqns, cons_eqns_terms, save_file):
    ...
    if save_file == 'yes':
        ret_dataframes['utilitylist_bilinear'].to_csv('C:\\Optimization_zlc\\01.utilitylist_bilinear.csv')
        ret_dataframes['processlist_bilinear'].to_csv('C:\\Optimization_zlc\\02.processlist_bilinear.csv')
        ret_dataframes['streams_bilinear'].to_csv('C:\\Optimization_zlc\\03.streams_bilinear.csv')
        ret_dataframes['cons_eqns_terms_bilinear'].to_csv('C:\\Optimization_zlc\\04.cons_eqns_terms_bilinear.csv')
        ret_dataframes['utilitylist_linear'].to_csv('C:\\Optimization_zlc\\05.utilitylist_linear.csv')
        ret_dataframes['processlist_linear'].to_csv('C:\\Optimization_zlc\\06.processlist_linear.csv')
        ret_dataframes['streams_linear'].to_csv('C:\\Optimization_zlc\\07.streams_linear.csv')
        ret_dataframes['cons_eqns_terms_linear'].to_csv('C:\\Optimization_zlc\\08.cons_eqns_terms_linear.csv')
        ret_dataframes['cons_eqns_all'].to_csv('C:\\Optimization_zlc\\09.cons_eqns_all.csv')
        
        layerslist.to_csv('C:\\Optimization_zlc\\10.layerslist_orginal.csv')
        utilitylist.to_csv('C:\\Optimization_zlc\\11.utilitylist_orginal.csv')
        processlist.to_csv('C:\\Optimization_zlc\\12.processlist_orginal.csv')
        streams.to_csv('C:\\Optimization_zlc\\13.streams_orginal.csv')
        cons_eqns.to_csv('C:\\Optimization_zlc\\14.cons_eqns_orginal.csv')
        cons_eqns_terms.to_csv('C:\\Optimization_zlc\\15.cons_eqns_terms_orginal.csv')  
