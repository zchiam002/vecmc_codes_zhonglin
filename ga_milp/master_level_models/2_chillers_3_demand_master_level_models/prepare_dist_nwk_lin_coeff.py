...
def prepare_dist_nwk_lin_coeff ():
    ...
    all_combi_dist_pump_lin_coeff = pd.DataFrame(columns = ['nwk_choice', 'ice_1', 'ice_2', 'tro_1', 'tro_2', 'fir_1', 'fir_2', 'fir_3', 'p1_m_coeff',
                                                            'p1_p_coeff', 'p1_cst', 'p1_max_m', 'p2_m_coeff', 'p2_p_coeff', 'p2_cst', 'p2_max_m', 
                                                            'p3_m_coeff', 'p3_p_coeff', 'p3_cst', 'p3_max_m'])
    ...
    #############################################################################################################################################################################
        ...
        if all_pump_nwk_combi['nwk_choice'][i] == 0:
            ...
            temp_data = [all_pump_nwk_combi['nwk_choice'][i], all_pump_nwk_combi['ice_1'][i], all_pump_nwk_combi['ice_2'][i], all_pump_nwk_combi['tro_1'][i],
                         ...
                         p1_m_coef, p1_p_coeff, p1_cst, p1_max_m, p2_m_coef, p2_p_coeff, p2_cst, p2_max_m, p3_m_coef, p3_p_coeff, p3_cst, p3_max_m]
            temp_data_df = pd.DataFrame(data = [temp_data], columns = ['nwk_choice', 'ice_1', 'ice_2', 'tro_1', 'tro_2', 'fir_1', 'fir_2', 'fir_3', 'p1_m_coeff', 'p1_p_coeff', 'p1_cst', 
                                                           'p1_max_m', 'p2_m_coeff', 'p2_p_coeff', 'p2_cst', 'p2_max_m', 'p3_m_coeff', 'p3_p_coeff', 'p3_cst', 'p3_max_m'])
    ...
    #############################################################################################################################################################################
            ...
            temp_data = [all_pump_nwk_combi['nwk_choice'][i], all_pump_nwk_combi['ice_1'][i], all_pump_nwk_combi['ice_2'][i], all_pump_nwk_combi['tro_1'][i],
                         all_pump_nwk_combi['tro_2'][i], all_pump_nwk_combi['fir_1'][i], all_pump_nwk_combi['fir_2'][i], all_pump_nwk_combi['fir_3'][i],
                         p1_m_coef, p1_p_coeff, p1_cst, p1_max_m, p2_m_coef, p2_p_coeff, p2_cst, p2_max_m, 0, 0, 0, 0]
            temp_data_df = pd.DataFrame(data = [temp_data], columns = ['nwk_choice', 'ice_1', 'ice_2', 'tro_1', 'tro_2', 'fir_1', 'fir_2', 'fir_3', 'p1_m_coeff', 'p1_p_coeff', 'p1_cst', 
                                                           'p1_max_m', 'p2_m_coeff', 'p2_p_coeff', 'p2_cst', 'p2_max_m', 'p3_m_coeff', 'p3_p_coeff', 'p3_cst', 'p3_max_m'])
            all_combi_dist_pump_lin_coeff = all_combi_dist_pump_lin_coeff.append(temp_data_df, ignore_index=True)                         
    ...
    ############################################################################################################################################################################
            ...
            temp_data = [all_pump_nwk_combi['nwk_choice'][i], all_pump_nwk_combi['ice_1'][i], all_pump_nwk_combi['ice_2'][i], all_pump_nwk_combi['tro_1'][i],
                         all_pump_nwk_combi['tro_2'][i], all_pump_nwk_combi['fir_1'][i], all_pump_nwk_combi['fir_2'][i], all_pump_nwk_combi['fir_3'][i],
                         p1_m_coef, p1_p_coeff, p1_cst, p1_max_m, 0, 0, 0, 0, 0, 0, 0, 0]
            temp_data_df = pd.DataFrame(data = [temp_data], columns = ['nwk_choice', 'ice_1', 'ice_2', 'tro_1', 'tro_2', 'fir_1', 'fir_2', 'fir_3', 'p1_m_coeff', 'p1_p_coeff', 'p1_cst', 
                                                           'p1_max_m', 'p2_m_coeff', 'p2_p_coeff', 'p2_cst', 'p2_max_m', 'p3_m_coeff', 'p3_p_coeff', 'p3_cst', 'p3_max_m'])
            all_combi_dist_pump_lin_coeff = all_combi_dist_pump_lin_coeff.append(temp_data_df, ignore_index=True)
            
    all_combi_dist_pump_lin_coeff.to_csv('C:\\Optimization_zlc\\master_level_models\\2_chillers_3_demand_master_level_models\\look_up_tables\\dist_pump_lincoeff.csv')
