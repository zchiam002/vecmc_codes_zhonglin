...
def prepare_slave_param_csv_vtest2 (var_converted, evap_cond_pump_lincoeff, dist_pump_1, dist_pump_2, dist_pump_3, weather, demand, nwk_choice, piecewise_steps):
    ...
    ##6
    input_value = {}
    input_value['Name'] = 'chiller2_nwk_choice_' + str(nwk_choice) + '_etret' 
    input_value['Value'] = var_converted[0]
    input_value['Unit'] = 'K'
    ...
    ##7
    input_value = {}
    input_value['Name'] = 'chiller2_nwk_choice_' + str(nwk_choice) + '_ctin' 
    input_value['Value'] = var_converted[1]
    input_value['Unit'] = 'K'
    ...
    ##8
    input_value = {}
    input_value['Name'] = 'chiller2_nwk_choice_' + str(nwk_choice) + '_tenwkflow' 
    input_value['Value'] = var_converted[2]
    input_value['Unit'] = 'm3/h'
    ...
    ##9
    input_value = {}
    input_value['Name'] = 'chiller2_nwk_choice_' + str(nwk_choice) + '_tcnwkflow'
    input_value['Value'] = var_converted[3]
    input_value['Unit'] = 'm3/h'
    ...
    ##10
    input_value = {}
    input_value['Name'] = 'chiller2_nwk_choice_' + str(nwk_choice) + '_piecewise_steps'
    input_value['Value'] = piecewise_steps
    input_value['Unit'] = 'm3/h'
    ...
    ##13
    input_value = {}
    input_value['Name'] = 'hsb_substation_nwk_choice_' + str(nwk_choice) + '_demand' 
    ...
    ##14
    input_value = {}
    input_value['Name'] = 'hsb_substation_nwk_choice_' + str(nwk_choice) + '_totalflownwk' 
    input_value['Value'] = var_converted[2]
    input_value['Unit'] = 'm3/h'
    ...
    ##15
    input_value = {}
    input_value['Name'] = 'pfa_substation_nwk_choice_' + str(nwk_choice) + '_demand' 
    ...
    ##16
    input_value = {}
    input_value['Name'] = 'pfa_substation_nwk_choice_' + str(nwk_choice) + '_totalflownwk' 
    input_value['Value'] = var_converted[2]
    input_value['Unit'] = 'm3/h'
