...
def convert_mdv_to_slave_param_v2 (thread_number, var, demand, weather_and_ct_coeff, piecewise_steps):
    ...
    import os
    current_path = os.path.dirname(os.path.abspath(__file__))[:-67] + '\\'    
    import sys 
    sys.path.append(current_path + 'master_level_models\\manu_revision_chiller_only_with_dist_nwk_master\\prep_functions\\')
    import os.path
    ...
    csv_save_loc = current_path + 'slave_convex_handlers\\master_values\\'
