...
def dist_nwk_system_bounds ():
    ...
    ##The flow limit will be decided by the largest pump
    flow_max = 3000 
    ...
    Al_2, Al_1 = convert_to_quadratic(A_new_lower, flow_max)
    Au_2, Au_1 = convert_to_quadratic(A_new_upper, flow_max)
