...
def chiller_cond_ret_mflow (ch_c_r_mf_mdv, processlist, streams, cons_eqns, cons_eqns_terms):
    import pandas as pd 

    ##Model description:
    ##This model represents the required return flowrate demand from the chiller models 
    
    ##Legend of input variables 
    
    ##ch_c_r_mret        --- condenser network total mass flowrate (m3/h)
    
    ##Processing list of master decision variables as parameters 
    ch_c_r_mret = ch_c_r_mf_mdv['Value'][0]
    ...
    ch_ret_mf['Variable1'] = 'm_f'                                                                                                     
    ch_ret_mf['Variable2'] = '-' 
    ch_ret_mf['Fmin_v1'] = 0 
    ch_ret_mf['Fmax_v1'] = chiller_cond_ret_mflow['ch_r_cretflow']['value']                                                                                                                   
    ch_ret_mf['Fmin_v2'] = 0                                                                                                          
    ch_ret_mf['Fmax_v2'] = 0                                                                              
    ...
    stream1['Stream_coeff_v1_1'] = chiller_cond_ret_mflow['ch_r_cretflow']['value']
