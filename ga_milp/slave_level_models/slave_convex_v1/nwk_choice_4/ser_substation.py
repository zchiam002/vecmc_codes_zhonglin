...
def ser_substation (ser_ss_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    from nwk_choice_4.ser_substation_compute import ser_substation_compute
    import pandas as pd
    import numpy as np 
    ...
    ##7 
    ser_ss_constraint_eqn_coeff = {}
    ser_ss_constraint_eqn_coeff['value'] = ser_ss_calc[1,0]     ##The constraint coefficient term to ensure that the delta t of the hx on the cold side does not exceed max delta t
    ser_ss_constraint_eqn_coeff['units'] = '-'
    ser_ss_constraint_eqn_coeff['status'] = 'calc'
    ser_ss_constraint_eqn_coeff['ser_ss_constraint_eqn_coeff'] = ser_ss_constraint_eqn_coeff      
    ...
    ser_ss = {}
    ser_ss['Name'] = 'ser_ss'
    ser_ss['Variable1'] = 'm_perc'                                        ##The percentage of the total flowrate into the system                                                                                                     
    ser_ss['Variable2'] = 't_in'                                           ##Temperature of fluid entering the substation                                                              
    ser_ss['Fmin_v1'] = 0 
    ser_ss['Fmax_v1'] = 1                                                                                                                    
    ...
    ##Stream 3
    stream3 = {}                                                                
    stream3['Parent'] = 'ser_ss'                                                ##Temperature stream exiting the substation 
    ...
    term1['Coeff_v1_1'] = ser_ss_constraint_eqn_coeff['ser_ss_constraint_eqn_coeff']['value']
    term1['Coeff_v2_2'] = 0
    term1['Coeff_v2_1'] = 0
    term1['Coeff_v1v2'] = 0
    term1['Coeff_cst'] = 0
