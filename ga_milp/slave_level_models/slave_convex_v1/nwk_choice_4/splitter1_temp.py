...
def splitter1_temp (sp1_temp_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    ...
    ##Stream 5
    stream5 = {}                                                                ##Copied output to hsb substation 
    ...
    ##Stream 6
    stream6 = {}                                                                ##Copied output to hsb substation 
    stream6['Parent'] = 'sp1_temp'
    stream6['Type'] = 'balancing_only'
    stream6['Name'] = 'sp1_temp2ser_tout'
    stream6['Layer'] = 'sp1_temp2ser'
    ...
    ##Stream 7
    stream7 = {}                                                                ##Copied output to hsb substation 
    stream7['Parent'] = 'sp1_temp'
    stream7['Type'] = 'balancing_only'
    stream7['Name'] = 'sp1_temp2fir_tout'
    stream7['Layer'] = 'sp1_temp2fir'
