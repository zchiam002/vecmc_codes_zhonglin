...
def gv2_substation (gv2_ss_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    ...
    ##Dependent constants 
    gv2_ss_dc = np.zeros((3,1))                                 ##Initialize the list, note the number of constants 
    ...
    gv2_ss = {}
    gv2_ss['Name'] = 'gv2_ss'
    gv2_ss['Variable1'] = 'm_gv2ss_perc'                                        ##The percentage of the total flowrate into the system                                                                                                     
    gv2_ss['Variable2'] = 'tgv2ss_in'                                           ##Temperature of fluid entering the substation                                                              
    gv2_ss['Fmin_v1'] = 0 
    gv2_ss['Fmax_v1'] = 1                                                                                                                    
    ...
    ##Stream 3
    stream3 = {}                                                                
    stream3['Parent'] = 'gv2_ss'                                                ##Flowrate stream entering the substation 
    ...
    term1['Coeff_v1_1'] = (gv2_substation['gv2_ss_totalflownwk']['value'] * gv2_substation['gv2_ss_cp']['value']) / gv2_substation['gv2_ss_demand']['value']
    term1['Coeff_v2_2'] = 0
    term1['Coeff_v2_1'] = 0
    term1['Coeff_v1v2'] = 0
    term1['Coeff_cst'] = 0
