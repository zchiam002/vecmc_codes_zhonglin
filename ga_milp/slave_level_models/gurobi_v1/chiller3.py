...
def chiller3 (ch3_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    ...
    ch3_etret = ch3_mdv['Value'][0]
    ch3_ctin = ch3_mdv['Value'][1]
    ch3_tenwkflow = ch3_mdv['Value'][2]                    ##Total flowrate through all evaporators of all chillers 
    ch3_tcnwkflow = ch3_mdv['Value'][3]                    ##Total flowrate through all condensers of all chillers 
    ...
    ch3_cp['units'] = 'kJ'
    ch3_cp['status'] = 'cst'
    chiller3['ch3_cp'] = ch3_cp 

    ##Dependent constants
    ch3_dc = np.zeros((9,1))                       #Initialize the list, note the number of constants
    ...
    ##Unit 1
    ch3_1_e = {}
    ch3_1_e['Name'] = 'ch3_1_evap'
    ch3_1_e['Variable1'] = 'm_evap_perc'                                                                                                      ##Percentage of flowrate from the entire evaporator network 
    ch3_1_e['Variable2'] = 'tevap_out'                                                                                                        ##Chilled water setpoint temperature 
    ch3_1_e['Fmin_v1'] = 0 
    ch3_1_e['Fmax_v1'] = 1                                                                                                                    ##Maximum percentage is 100% 
    ch3_1_e['Fmin_v2'] = 273.15 + 1                                                                                                           ##The minimum supply temperature of the chiller is 1 deg 
    ch3_1_e['Fmax_v2'] = chiller3['ch3_evaptret']['value']                                                                                    ##The maximum supply temperature of the chiller is that of the return temperature
    ch3_1_e['Coeff_v1_2'] = 0                                                                                                                 ##This illustrates the relationship between the variables  
    ch3_1_e['Coeff_v1_1'] = chiller3['ch3_totalenwkflow']['value'] * chiller3['ch3_cp']['value'] * chiller3['ch3_evaptret']['value']          ##The relationship is Qe = m_evap_perc*m_total*Cp*Tevap_in - m_evap_perc*m_total*Cp*Tevap_out
    ch3_1_e['Coeff_v2_2'] = 0
    ch3_1_e['Coeff_v2_1'] = 0
    ch3_1_e['Coeff_v1_v2'] = -chiller3['ch3_totalenwkflow']['value'] * chiller3['ch3_cp']['value'] 
    ch3_1_e['Coeff_cst'] = 0
    ch3_1_e['Fmin'] = chiller3['ch3_f1']['value'] * chiller3['ch3_rated_cap']['value']
    ch3_1_e['Fmax'] = chiller3['ch3_f2']['value'] * chiller3['ch3_rated_cap']['value']
    ch3_1_e['Cost_v1_2'] = 0
    ch3_1_e['Cost_v1_1'] = 0
    ch3_1_e['Cost_v2_2'] = 0
    ch3_1_e['Cost_v2_1'] = 0
    ch3_1_e['Cost_v1_v2'] = 0
    ch3_1_e['Cost_cst'] = 0
    ch3_1_e['Cinv_v1_2'] = 0
    ch3_1_e['Cinv_v1_1'] = 0
    ch3_1_e['Cinv_v2_2'] = 0
    ch3_1_e['Cinv_v2_1'] = 0
    ch3_1_e['Cinv_v1_v2'] = 0
    ch3_1_e['Cinv_cst'] = 0
    ch3_1_e['Power_v1_2'] = 0
    ch3_1_e['Power_v1_1'] = 0
    ch3_1_e['Power_v2_2'] = 0
    ch3_1_e['Power_v2_1'] = 0
    ch3_1_e['Power_v1_v2'] = chiller3['ch3_egrad1']['value']
    ch3_1_e['Power_cst'] = chiller3['ch3_int1']['value']
    ch3_1_e['Impact_v1_2'] = 0
    ch3_1_e['Impact_v1_1'] = 0
    ch3_1_e['Impact_v2_2'] = 0
    ch3_1_e['Impact_v2_1'] = 0
    ch3_1_e['Impact_v1_v2'] = 0
    ch3_1_e['Impact_cst'] = 0

    unitinput = [ch3_1_e['Name'], ch3_1_e['Variable1'], ch3_1_e['Variable2'], ch3_1_e['Fmin_v1'], ch3_1_e['Fmax_v1'], ch3_1_e['Fmin_v2'], ch3_1_e['Fmax_v2'], ch3_1_e['Coeff_v1_2'], 
                ch3_1_e['Coeff_v1_1'], ch3_1_e['Coeff_v2_2'], ch3_1_e['Coeff_v2_1'], ch3_1_e['Coeff_v1_v2'], ch3_1_e['Coeff_cst'], ch3_1_e['Fmin'], ch3_1_e['Fmax'], ch3_1_e['Cost_v1_2'], 
                ch3_1_e['Cost_v1_1'], ch3_1_e['Cost_v2_2'], ch3_1_e['Cost_v2_1'], ch3_1_e['Cost_v1_v2'], ch3_1_e['Cost_cst'], ch3_1_e['Cinv_v1_2'], ch3_1_e['Cinv_v1_1'], ch3_1_e['Cinv_v2_2'], 
                ch3_1_e['Cinv_v2_1'], ch3_1_e['Cinv_v1_v2'], ch3_1_e['Cinv_cst'], ch3_1_e['Power_v1_2'], ch3_1_e['Power_v1_1'], ch3_1_e['Power_v2_2'], ch3_1_e['Power_v2_1'], 
                ch3_1_e['Power_v1_v2'], ch3_1_e['Power_cst'], ch3_1_e['Impact_v1_2'], ch3_1_e['Impact_v1_1'], ch3_1_e['Impact_v2_2'], ch3_1_e['Impact_v2_1'], ch3_1_e['Impact_v1_v2'], 
                ch3_1_e['Impact_cst']]   
    ...
    ##Unit 2
    ch3_1_c = {}
    ch3_1_c['Name'] = 'ch3_1_cond'
    ch3_1_c['Variable1'] = 'm_cond_perc'                                                                                                      ##Percentage of flowrate from the entire condenser network 
    ch3_1_c['Variable2'] = 'tcond_out'                                                                                                        ##Condenser water setpoint temperature 
    ch3_1_c['Fmin_v1'] = 0 
    ch3_1_c['Fmax_v1'] = 1                                                                                                                    ##Maximum percentage is 100% 
    ch3_1_c['Fmin_v2'] = chiller3['ch3_condtin']['value'] + 1                                                                                          ##The minimum condenser exit temperature is 1 deg above entry temperature 
    ch3_1_c['Fmax_v2'] = chiller3['ch3_condtin']['value'] + 10                                                                                         ##The maximum condenser exit temperature is 10 degrees above entry temperature
    ch3_1_c['Coeff_v1_2'] = 0                                                                                                                 ##This illustrates the relationship between the variables  
    ch3_1_c['Coeff_v1_1'] = -chiller3['ch3_totalcnwkflow']['value'] * chiller3['ch3_cp']['value'] * chiller3['ch3_condtin']['value']          ##The relationship is Qc = m_cond_perc*m_total*Cp*Tcond_in - m_cond_perc*m_total*Cp*Tcond_out
    ch3_1_c['Coeff_v2_2'] = 0
    ch3_1_c['Coeff_v2_1'] = 0
    ch3_1_c['Coeff_v1_v2'] = chiller3['ch3_totalcnwkflow']['value'] * chiller3['ch3_cp']['value'] 
    ch3_1_c['Coeff_cst'] = 0
    ch3_1_c['Fmin'] = chiller3['ch3_f1']['value'] * chiller3['ch3_rated_cap']['value'] * chiller3['ch3_qc_coeff']['value']
    ch3_1_c['Fmax'] = chiller3['ch3_f2']['value'] * chiller3['ch3_rated_cap']['value'] * chiller3['ch3_qc_coeff']['value']
    ch3_1_c['Cost_v1_2'] = 0
    ch3_1_c['Cost_v1_1'] = 0
    ch3_1_c['Cost_v2_2'] = 0
    ch3_1_c['Cost_v2_1'] = 0
    ch3_1_c['Cost_v1_v2'] = 0
    ch3_1_c['Cost_cst'] = 0
    ch3_1_c['Cinv_v1_2'] = 0
    ch3_1_c['Cinv_v1_1'] = 0
    ch3_1_c['Cinv_v2_2'] = 0
    ch3_1_c['Cinv_v2_1'] = 0
    ch3_1_c['Cinv_v1_v2'] = 0
    ch3_1_c['Cinv_cst'] = 0
    ch3_1_c['Power_v1_2'] = 0
    ch3_1_c['Power_v1_1'] = 0
    ch3_1_c['Power_v2_2'] = 0
    ch3_1_c['Power_v2_1'] = 0
    ch3_1_c['Power_v1_v2'] = 0                                                                                                                ##Already accounted for in the evaporator unit
    ch3_1_c['Power_cst'] = 0
    ch3_1_c['Impact_v1_2'] = 0
    ch3_1_c['Impact_v1_1'] = 0
    ch3_1_c['Impact_v2_2'] = 0
    ch3_1_c['Impact_v2_1'] = 0
    ch3_1_c['Impact_v1_v2'] = 0
    ch3_1_c['Impact_cst'] = 0

    unitinput = [ch3_1_c['Name'], ch3_1_c['Variable1'], ch3_1_c['Variable2'], ch3_1_c['Fmin_v1'], ch3_1_c['Fmax_v1'], ch3_1_c['Fmin_v2'], ch3_1_c['Fmax_v2'], ch3_1_c['Coeff_v1_2'], ch3_1_c['Coeff_v1_1'], 
                ch3_1_c['Coeff_v2_2'], ch3_1_c['Coeff_v2_1'], ch3_1_c['Coeff_v1_v2'], ch3_1_c['Coeff_cst'], ch3_1_c['Fmin'], ch3_1_c['Fmax'], ch3_1_c['Cost_v1_2'], ch3_1_c['Cost_v1_1'], 
                ch3_1_c['Cost_v2_2'], ch3_1_c['Cost_v2_1'], ch3_1_c['Cost_v1_v2'], ch3_1_c['Cost_cst'], ch3_1_c['Cinv_v1_2'], ch3_1_c['Cinv_v1_1'], ch3_1_c['Cinv_v2_2'], ch3_1_c['Cinv_v2_1'], 
                ch3_1_c['Cinv_v1_v2'], ch3_1_c['Cinv_cst'], ch3_1_c['Power_v1_2'], ch3_1_c['Power_v1_1'], ch3_1_c['Power_v2_2'], ch3_1_c['Power_v2_1'], ch3_1_c['Power_v1_v2'], ch3_1_c['Power_cst'], 
                ch3_1_c['Impact_v1_2'], ch3_1_c['Impact_v1_1'], ch3_1_c['Impact_v2_2'], ch3_1_c['Impact_v2_1'], ch3_1_c['Impact_v1_v2'], ch3_1_c['Impact_cst']]   
    unitdf = pd.DataFrame(data = [unitinput], columns=['Name', 'Variable1', 'Variable2', 'Fmin_v1', 'Fmax_v1', 'Fmin_v2', 'Fmax_v2', 'Coeff_v1_2', 'Coeff_v1_1', 'Coeff_v2_2', 'Coeff_v2_1',
                                                      'Coeff_v1_v2', 'Coeff_cst', 'Fmin', 'Fmax', 'Cost_v1_2', 'Cost_v1_1', 'Cost_v2_2', 'Cost_v2_1', 'Cost_v1_v2', 'Cost_cst', 'Cinv_v1_2',
                                                      'Cinv_v1_1', 'Cinv_v2_2', 'Cinv_v2_1', 'Cinv_v1_v2', 'Cinv_cst', 'Power_v1_2', 'Power_v1_1', 'Power_v2_2', 'Power_v2_1', 'Power_v1_v2',
                                                      'Power_cst', 'Impact_v1_2', 'Impact_v1_1', 'Impact_v2_2', 'Impact_v2_1', 'Impact_v1_v2', 'Impact_cst'])
    ...
    ##Unit 3
    ch3_2_e = {}
    ch3_2_e['Name'] = 'ch3_2_evap'
    ch3_2_e['Variable1'] = 'm_evap_perc'                                                                                                      ##Percentage of flowrate from the entire evaporator network 
    ch3_2_e['Variable2'] = 'tevap_out'                                                                                                        ##Chilled water setpoint temperature 
    ch3_2_e['Fmin_v1'] = 0 
    ch3_2_e['Fmax_v1'] = 1                                                                                                                    ##Maximum percentage is 100% 
    ch3_2_e['Fmin_v2'] = 273.15 + 1                                                                                                           ##The minimum supply temperature of the chiller is 1 deg 
    ch3_2_e['Fmax_v2'] = chiller3['ch3_evaptret']['value']                                                                                    ##The maximum supply temperature of the chiller is that of the return temperature
    ch3_2_e['Coeff_v1_2'] = 0                                                                                                                 ##This illustrates the relationship between the variables  
    ch3_2_e['Coeff_v1_1'] = chiller3['ch3_totalenwkflow']['value'] * chiller3['ch3_cp']['value'] * chiller3['ch3_evaptret']['value']          ##The relationship is Qe = m_evap_perc*m_total*Cp*Tevap_in - m_evap_perc*m_total*Cp*Tevap_out
    ch3_2_e['Coeff_v2_2'] = 0
    ch3_2_e['Coeff_v2_1'] = 0
    ch3_2_e['Coeff_v1_v2'] = -chiller3['ch3_totalenwkflow']['value'] * chiller3['ch3_cp']['value'] 
    ch3_2_e['Coeff_cst'] = 0
    ch3_2_e['Fmin'] = chiller3['ch3_f2']['value'] * chiller3['ch3_rated_cap']['value']
    ch3_2_e['Fmax'] = chiller3['ch3_f3']['value'] * chiller3['ch3_rated_cap']['value']
    ch3_2_e['Cost_v1_2'] = 0
    ch3_2_e['Cost_v1_1'] = 0
    ch3_2_e['Cost_v2_2'] = 0
    ch3_2_e['Cost_v2_1'] = 0
    ch3_2_e['Cost_v1_v2'] = 0
    ch3_2_e['Cost_cst'] = 0
    ch3_2_e['Cinv_v1_2'] = 0
    ch3_2_e['Cinv_v1_1'] = 0
    ch3_2_e['Cinv_v2_2'] = 0
    ch3_2_e['Cinv_v2_1'] = 0
    ch3_2_e['Cinv_v1_v2'] = 0
    ch3_2_e['Cinv_cst'] = 0
    ch3_2_e['Power_v1_2'] = 0
    ch3_2_e['Power_v1_1'] = 0
    ch3_2_e['Power_v2_2'] = 0
    ch3_2_e['Power_v2_1'] = 0
    ch3_2_e['Power_v1_v2'] = chiller3['ch3_egrad2']['value']
    ch3_2_e['Power_cst'] = chiller3['ch3_int2']['value']
    ch3_2_e['Impact_v1_2'] = 0
    ch3_2_e['Impact_v1_1'] = 0
    ch3_2_e['Impact_v2_2'] = 0
    ch3_2_e['Impact_v2_1'] = 0
    ch3_2_e['Impact_v1_v2'] = 0
    ch3_2_e['Impact_cst'] = 0

    unitinput = [ch3_2_e['Name'], ch3_2_e['Variable1'], ch3_2_e['Variable2'], ch3_2_e['Fmin_v1'], ch3_2_e['Fmax_v1'], ch3_2_e['Fmin_v2'], ch3_2_e['Fmax_v2'], ch3_2_e['Coeff_v1_2'], 
                ch3_2_e['Coeff_v1_1'], ch3_2_e['Coeff_v2_2'], ch3_2_e['Coeff_v2_1'], ch3_2_e['Coeff_v1_v2'], ch3_2_e['Coeff_cst'], ch3_2_e['Fmin'], ch3_2_e['Fmax'], ch3_2_e['Cost_v1_2'], 
                ch3_2_e['Cost_v1_1'], ch3_2_e['Cost_v2_2'], ch3_2_e['Cost_v2_1'], ch3_2_e['Cost_v1_v2'], ch3_2_e['Cost_cst'], ch3_2_e['Cinv_v1_2'], ch3_2_e['Cinv_v1_1'], ch3_2_e['Cinv_v2_2'], 
                ch3_2_e['Cinv_v2_1'], ch3_2_e['Cinv_v1_v2'], ch3_2_e['Cinv_cst'], ch3_2_e['Power_v1_2'], ch3_2_e['Power_v1_1'], ch3_2_e['Power_v2_2'], ch3_2_e['Power_v2_1'], 
                ch3_2_e['Power_v1_v2'], ch3_2_e['Power_cst'], ch3_2_e['Impact_v1_2'], ch3_2_e['Impact_v1_1'], ch3_2_e['Impact_v2_2'], ch3_2_e['Impact_v2_1'], ch3_2_e['Impact_v1_v2'], 
                ch3_2_e['Impact_cst']]   
    unitdf = pd.DataFrame(data = [unitinput], columns=['Name', 'Variable1', 'Variable2', 'Fmin_v1', 'Fmax_v1', 'Fmin_v2', 'Fmax_v2', 'Coeff_v1_2', 'Coeff_v1_1', 'Coeff_v2_2', 'Coeff_v2_1',
                                                      'Coeff_v1_v2', 'Coeff_cst', 'Fmin', 'Fmax', 'Cost_v1_2', 'Cost_v1_1', 'Cost_v2_2', 'Cost_v2_1', 'Cost_v1_v2', 'Cost_cst', 'Cinv_v1_2',
                                                      'Cinv_v1_1', 'Cinv_v2_2', 'Cinv_v2_1', 'Cinv_v1_v2', 'Cinv_cst', 'Power_v1_2', 'Power_v1_1', 'Power_v2_2', 'Power_v2_1', 'Power_v1_v2',
    ...
    ##Unit 4
    ch3_2_c = {}
    ch3_2_c['Name'] = 'ch3_2_cond'
    ch3_2_c['Variable1'] = 'm_cond_perc'                                                                                                      ##Percentage of flowrate from the entire condenser network 
    ch3_2_c['Variable2'] = 'tcond_out'                                                                                                        ##Condenser water setpoint temperature 
    ch3_2_c['Fmin_v1'] = 0 
    ch3_2_c['Fmax_v1'] = 1                                                                                                                    ##Maximum percentage is 100% 
    ch3_2_c['Fmin_v2'] = chiller3['ch3_condtin']['value'] + 1                                                                                          ##The minimum condenser exit temperature is 1 deg above entry temperature 
    ch3_2_c['Fmax_v2'] = chiller3['ch3_condtin']['value'] + 10                                                                                         ##The maximum condenser exit temperature is 10 degrees above entry temperature
    ch3_2_c['Coeff_v1_2'] = 0                                                                                                                 ##This illustrates the relationship between the variables  
    ch3_2_c['Coeff_v1_1'] = -chiller3['ch3_totalcnwkflow']['value'] * chiller3['ch3_cp']['value'] * chiller3['ch3_condtin']['value']          ##The relationship is Qc = m_cond_perc*m_total*Cp*Tcond_in - m_cond_perc*m_total*Cp*Tcond_out
    ch3_2_c['Coeff_v2_2'] = 0
    ch3_2_c['Coeff_v2_1'] = 0
    ch3_2_c['Coeff_v1_v2'] = chiller3['ch3_totalcnwkflow']['value'] * chiller3['ch3_cp']['value'] 
    ch3_2_c['Coeff_cst'] = 0
    ch3_2_c['Fmin'] = chiller3['ch3_f2']['value'] * chiller3['ch3_rated_cap']['value'] * chiller3['ch3_qc_coeff']['value']
    ch3_2_c['Fmax'] = chiller3['ch3_f3']['value'] * chiller3['ch3_rated_cap']['value'] * chiller3['ch3_qc_coeff']['value']
    ch3_2_c['Cost_v1_2'] = 0
    ch3_2_c['Cost_v1_1'] = 0
    ch3_2_c['Cost_v2_2'] = 0
    ch3_2_c['Cost_v2_1'] = 0
    ch3_2_c['Cost_v1_v2'] = 0
    ch3_2_c['Cost_cst'] = 0
    ch3_2_c['Cinv_v1_2'] = 0
    ch3_2_c['Cinv_v1_1'] = 0
    ch3_2_c['Cinv_v2_2'] = 0
    ch3_2_c['Cinv_v2_1'] = 0
    ch3_2_c['Cinv_v1_v2'] = 0
    ch3_2_c['Cinv_cst'] = 0
    ch3_2_c['Power_v1_2'] = 0
    ch3_2_c['Power_v1_1'] = 0
    ch3_2_c['Power_v2_2'] = 0
    ch3_2_c['Power_v2_1'] = 0
    ch3_2_c['Power_v1_v2'] = 0                                                                                                                ##Already accounted for in the evaporator unit
    ch3_2_c['Power_cst'] = 0
    ch3_2_c['Impact_v1_2'] = 0
    ch3_2_c['Impact_v1_1'] = 0
    ch3_2_c['Impact_v2_2'] = 0
    ch3_2_c['Impact_v2_1'] = 0
    ch3_2_c['Impact_v1_v2'] = 0
    ch3_2_c['Impact_cst'] = 0

    unitinput = [ch3_2_c['Name'], ch3_2_c['Variable1'], ch3_2_c['Variable2'], ch3_2_c['Fmin_v1'], ch3_2_c['Fmax_v1'], ch3_2_c['Fmin_v2'], ch3_2_c['Fmax_v2'], ch3_2_c['Coeff_v1_2'], ch3_2_c['Coeff_v1_1'], 
                ch3_2_c['Coeff_v2_2'], ch3_2_c['Coeff_v2_1'], ch3_2_c['Coeff_v1_v2'], ch3_2_c['Coeff_cst'], ch3_2_c['Fmin'], ch3_2_c['Fmax'], ch3_2_c['Cost_v1_2'], ch3_2_c['Cost_v1_1'], 
                ch3_2_c['Cost_v2_2'], ch3_2_c['Cost_v2_1'], ch3_2_c['Cost_v1_v2'], ch3_2_c['Cost_cst'], ch3_2_c['Cinv_v1_2'], ch3_2_c['Cinv_v1_1'], ch3_2_c['Cinv_v2_2'], ch3_2_c['Cinv_v2_1'], 
                ch3_2_c['Cinv_v1_v2'], ch3_2_c['Cinv_cst'], ch3_2_c['Power_v1_2'], ch3_2_c['Power_v1_1'], ch3_2_c['Power_v2_2'], ch3_2_c['Power_v2_1'], ch3_2_c['Power_v1_v2'], ch3_2_c['Power_cst'], 
                ch3_2_c['Impact_v1_2'], ch3_2_c['Impact_v1_1'], ch3_2_c['Impact_v2_2'], ch3_2_c['Impact_v2_1'], ch3_2_c['Impact_v1_v2'], ch3_2_c['Impact_cst']]   
    unitdf = pd.DataFrame(data = [unitinput], columns=['Name', 'Variable1', 'Variable2', 'Fmin_v1', 'Fmax_v1', 'Fmin_v2', 'Fmax_v2', 'Coeff_v1_2', 'Coeff_v1_1', 'Coeff_v2_2', 'Coeff_v2_1',
                                                      'Coeff_v1_v2', 'Coeff_cst', 'Fmin', 'Fmax', 'Cost_v1_2', 'Cost_v1_1', 'Cost_v2_2', 'Cost_v2_1', 'Cost_v1_v2', 'Cost_cst', 'Cinv_v1_2',
                                                      'Cinv_v1_1', 'Cinv_v2_2', 'Cinv_v2_1', 'Cinv_v1_v2', 'Cinv_cst', 'Power_v1_2', 'Power_v1_1', 'Power_v2_2', 'Power_v2_1', 'Power_v1_v2',
                                                      'Power_cst', 'Impact_v1_2', 'Impact_v1_1', 'Impact_v2_2', 'Impact_v2_1', 'Impact_v1_v2', 'Impact_cst'])
    ...
    ##Unit 5
    ch3_3_e = {}
    ch3_3_e['Name'] = 'ch3_3_evap'
    ch3_3_e['Variable1'] = 'm_evap_perc'                                                                                                      ##Percentage of flowrate from the entire evaporator network 
    ch3_3_e['Variable2'] = 'tevap_out'                                                                                                        ##Chilled water setpoint temperature 
    ch3_3_e['Fmin_v1'] = 0 
    ch3_3_e['Fmax_v1'] = 1                                                                                                                    ##Maximum percentage is 100% 
    ch3_3_e['Fmin_v2'] = 273.15 + 1                                                                                                           ##The minimum supply temperature of the chiller is 1 deg 
    ch3_3_e['Fmax_v2'] = chiller3['ch3_evaptret']['value']                                                                                    ##The maximum supply temperature of the chiller is that of the return temperature
    ch3_3_e['Coeff_v1_2'] = 0                                                                                                                 ##This illustrates the relationship between the variables  
    ch3_3_e['Coeff_v1_1'] = chiller3['ch3_totalenwkflow']['value'] * chiller3['ch3_cp']['value'] * chiller3['ch3_evaptret']['value']          ##The relationship is Qe = m_evap_perc*m_total*Cp*Tevap_in - m_evap_perc*m_total*Cp*Tevap_out
    ch3_3_e['Coeff_v2_2'] = 0
    ch3_3_e['Coeff_v2_1'] = 0
    ch3_3_e['Coeff_v1_v2'] = -chiller3['ch3_totalenwkflow']['value'] * chiller3['ch3_cp']['value'] 
    ch3_3_e['Coeff_cst'] = 0
    ch3_3_e['Fmin'] = chiller3['ch3_f3']['value'] * chiller3['ch3_rated_cap']['value']
    ch3_3_e['Fmax'] = chiller3['ch3_f4']['value'] * chiller3['ch3_rated_cap']['value']
    ch3_3_e['Cost_v1_2'] = 0
    ch3_3_e['Cost_v1_1'] = 0
    ch3_3_e['Cost_v2_2'] = 0
    ch3_3_e['Cost_v2_1'] = 0
    ch3_3_e['Cost_v1_v2'] = 0
    ch3_3_e['Cost_cst'] = 0
    ch3_3_e['Cinv_v1_2'] = 0
    ch3_3_e['Cinv_v1_1'] = 0
    ch3_3_e['Cinv_v2_2'] = 0
    ch3_3_e['Cinv_v2_1'] = 0
    ch3_3_e['Cinv_v1_v2'] = 0
    ch3_3_e['Cinv_cst'] = 0
    ch3_3_e['Power_v1_2'] = 0
    ch3_3_e['Power_v1_1'] = 0
    ch3_3_e['Power_v2_2'] = 0
    ch3_3_e['Power_v2_1'] = 0
    ch3_3_e['Power_v1_v2'] = chiller3['ch3_egrad3']['value']
    ch3_3_e['Power_cst'] = chiller3['ch3_int3']['value']
    ch3_3_e['Impact_v1_2'] = 0
    ch3_3_e['Impact_v1_1'] = 0
    ch3_3_e['Impact_v2_2'] = 0
    ch3_3_e['Impact_v2_1'] = 0
    ch3_3_e['Impact_v1_v2'] = 0
    ch3_3_e['Impact_cst'] = 0

    unitinput = [ch3_3_e['Name'], ch3_3_e['Variable1'], ch3_3_e['Variable2'], ch3_3_e['Fmin_v1'], ch3_3_e['Fmax_v1'], ch3_3_e['Fmin_v2'], ch3_3_e['Fmax_v2'], ch3_3_e['Coeff_v1_2'], 
                ch3_3_e['Coeff_v1_1'], ch3_3_e['Coeff_v2_2'], ch3_3_e['Coeff_v2_1'], ch3_3_e['Coeff_v1_v2'], ch3_3_e['Coeff_cst'], ch3_3_e['Fmin'], ch3_3_e['Fmax'], ch3_3_e['Cost_v1_2'], 
                ch3_3_e['Cost_v1_1'], ch3_3_e['Cost_v2_2'], ch3_3_e['Cost_v2_1'], ch3_3_e['Cost_v1_v2'], ch3_3_e['Cost_cst'], ch3_3_e['Cinv_v1_2'], ch3_3_e['Cinv_v1_1'], ch3_3_e['Cinv_v2_2'], 
                ch3_3_e['Cinv_v2_1'], ch3_3_e['Cinv_v1_v2'], ch3_3_e['Cinv_cst'], ch3_3_e['Power_v1_2'], ch3_3_e['Power_v1_1'], ch3_3_e['Power_v2_2'], ch3_3_e['Power_v2_1'], 
                ch3_3_e['Power_v1_v2'], ch3_3_e['Power_cst'], ch3_3_e['Impact_v1_2'], ch3_3_e['Impact_v1_1'], ch3_3_e['Impact_v2_2'], ch3_3_e['Impact_v2_1'], ch3_3_e['Impact_v1_v2'], 
                ch3_3_e['Impact_cst']]   
    unitdf = pd.DataFrame(data = [unitinput], columns=['Name', 'Variable1', 'Variable2', 'Fmin_v1', 'Fmax_v1', 'Fmin_v2', 'Fmax_v2', 'Coeff_v1_2', 'Coeff_v1_1', 'Coeff_v2_2', 'Coeff_v2_1',
                                                      'Coeff_v1_v2', 'Coeff_cst', 'Fmin', 'Fmax', 'Cost_v1_2', 'Cost_v1_1', 'Cost_v2_2', 'Cost_v2_1', 'Cost_v1_v2', 'Cost_cst', 'Cinv_v1_2',
                                                      'Cinv_v1_1', 'Cinv_v2_2', 'Cinv_v2_1', 'Cinv_v1_v2', 'Cinv_cst', 'Power_v1_2', 'Power_v1_1', 'Power_v2_2', 'Power_v2_1', 'Power_v1_v2',
    ...
    ##Unit 6
    ch3_3_c = {}
    ch3_3_c['Name'] = 'ch3_3_cond'
    ch3_3_c['Variable1'] = 'm_cond_perc'                                                                                                      ##Percentage of flowrate from the entire condenser network 
    ch3_3_c['Variable2'] = 'tcond_out'                                                                                                        ##Condenser water setpoint temperature 
    ch3_3_c['Fmin_v1'] = 0 
    ch3_3_c['Fmax_v1'] = 1                                                                                                                    ##Maximum percentage is 100% 
    ch3_3_c['Fmin_v2'] = chiller3['ch3_condtin']['value'] + 1                                                                                          ##The minimum condenser exit temperature is 1 deg above entry temperature 
    ch3_3_c['Fmax_v2'] = chiller3['ch3_condtin']['value'] + 10                                                                                         ##The maximum condenser exit temperature is 10 degrees above entry temperature
    ch3_3_c['Coeff_v1_2'] = 0                                                                                                                 ##This illustrates the relationship between the variables  
    ch3_3_c['Coeff_v1_1'] = -chiller3['ch3_totalcnwkflow']['value'] * chiller3['ch3_cp']['value'] * chiller3['ch3_condtin']['value']          ##The relationship is Qc = m_cond_perc*m_total*Cp*Tcond_in - m_cond_perc*m_total*Cp*Tcond_out
    ch3_3_c['Coeff_v2_2'] = 0
    ch3_3_c['Coeff_v2_1'] = 0
    ch3_3_c['Coeff_v1_v2'] = chiller3['ch3_totalcnwkflow']['value'] * chiller3['ch3_cp']['value'] 
    ch3_3_c['Coeff_cst'] = 0
    ch3_3_c['Fmin'] = chiller3['ch3_f3']['value'] * chiller3['ch3_rated_cap']['value'] * chiller3['ch3_qc_coeff']['value']
    ch3_3_c['Fmax'] = chiller3['ch3_f4']['value'] * chiller3['ch3_rated_cap']['value'] * chiller3['ch3_qc_coeff']['value']
    ch3_3_c['Cost_v1_2'] = 0
    ch3_3_c['Cost_v1_1'] = 0
    ch3_3_c['Cost_v2_2'] = 0
    ch3_3_c['Cost_v2_1'] = 0
    ch3_3_c['Cost_v1_v2'] = 0
    ch3_3_c['Cost_cst'] = 0
    ch3_3_c['Cinv_v1_2'] = 0
    ch3_3_c['Cinv_v1_1'] = 0
    ch3_3_c['Cinv_v2_2'] = 0
    ch3_3_c['Cinv_v2_1'] = 0
    ch3_3_c['Cinv_v1_v2'] = 0
    ch3_3_c['Cinv_cst'] = 0
    ch3_3_c['Power_v1_2'] = 0
    ch3_3_c['Power_v1_1'] = 0
    ch3_3_c['Power_v2_2'] = 0
    ch3_3_c['Power_v2_1'] = 0
    ch3_3_c['Power_v1_v2'] = 0                                                                                                                ##Already accounted for in the evaporator unit
    ch3_3_c['Power_cst'] = 0
    ch3_3_c['Impact_v1_2'] = 0
    ch3_3_c['Impact_v1_1'] = 0
    ch3_3_c['Impact_v2_2'] = 0
    ch3_3_c['Impact_v2_1'] = 0
    ch3_3_c['Impact_v1_v2'] = 0
    ch3_3_c['Impact_cst'] = 0

    unitinput = [ch3_3_c['Name'], ch3_3_c['Variable1'], ch3_3_c['Variable2'], ch3_3_c['Fmin_v1'], ch3_3_c['Fmax_v1'], ch3_3_c['Fmin_v2'], ch3_3_c['Fmax_v2'], ch3_3_c['Coeff_v1_2'], ch3_3_c['Coeff_v1_1'], 
                ch3_3_c['Coeff_v2_2'], ch3_3_c['Coeff_v2_1'], ch3_3_c['Coeff_v1_v2'], ch3_3_c['Coeff_cst'], ch3_3_c['Fmin'], ch3_3_c['Fmax'], ch3_3_c['Cost_v1_2'], ch3_3_c['Cost_v1_1'], 
                ch3_3_c['Cost_v2_2'], ch3_3_c['Cost_v2_1'], ch3_3_c['Cost_v1_v2'], ch3_3_c['Cost_cst'], ch3_3_c['Cinv_v1_2'], ch3_3_c['Cinv_v1_1'], ch3_3_c['Cinv_v2_2'], ch3_3_c['Cinv_v2_1'], 
                ch3_3_c['Cinv_v1_v2'], ch3_3_c['Cinv_cst'], ch3_3_c['Power_v1_2'], ch3_3_c['Power_v1_1'], ch3_3_c['Power_v2_2'], ch3_3_c['Power_v2_1'], ch3_3_c['Power_v1_v2'], ch3_3_c['Power_cst'], 
                ch3_3_c['Impact_v1_2'], ch3_3_c['Impact_v1_1'], ch3_3_c['Impact_v2_2'], ch3_3_c['Impact_v2_1'], ch3_3_c['Impact_v1_v2'], ch3_3_c['Impact_cst']]   
    unitdf = pd.DataFrame(data = [unitinput], columns=['Name', 'Variable1', 'Variable2', 'Fmin_v1', 'Fmax_v1', 'Fmin_v2', 'Fmax_v2', 'Coeff_v1_2', 'Coeff_v1_1', 'Coeff_v2_2', 'Coeff_v2_1',
                                                      'Coeff_v1_v2', 'Coeff_cst', 'Fmin', 'Fmax', 'Cost_v1_2', 'Cost_v1_1', 'Cost_v2_2', 'Cost_v2_1', 'Cost_v1_v2', 'Cost_cst', 'Cinv_v1_2',
                                                      'Cinv_v1_1', 'Cinv_v2_2', 'Cinv_v2_1', 'Cinv_v1_v2', 'Cinv_cst', 'Power_v1_2', 'Power_v1_1', 'Power_v2_2', 'Power_v2_1', 'Power_v1_v2',
                                                      'Power_cst', 'Impact_v1_2', 'Impact_v1_1', 'Impact_v2_2', 'Impact_v2_1', 'Impact_v1_v2', 'Impact_cst'])
    ...
    ##Unit 7
    ch3_4_e = {}
    ch3_4_e['Name'] = 'ch3_4_evap'
    ch3_4_e['Variable1'] = 'm_evap_perc'                                                                                                      ##Percentage of flowrate from the entire evaporator network 
    ch3_4_e['Variable2'] = 'tevap_out'                                                                                                        ##Chilled water setpoint temperature 
    ch3_4_e['Fmin_v1'] = 0 
    ch3_4_e['Fmax_v1'] = 1                                                                                                                    ##Maximum percentage is 100% 
    ch3_4_e['Fmin_v2'] = 273.15 + 1                                                                                                           ##The minimum supply temperature of the chiller is 1 deg 
    ch3_4_e['Fmax_v2'] = chiller3['ch3_evaptret']['value']                                                                                    ##The maximum supply temperature of the chiller is that of the return temperature
    ch3_4_e['Coeff_v1_2'] = 0                                                                                                                 ##This illustrates the relationship between the variables  
    ch3_4_e['Coeff_v1_1'] = chiller3['ch3_totalenwkflow']['value'] * chiller3['ch3_cp']['value'] * chiller3['ch3_evaptret']['value']          ##The relationship is Qe = m_evap_perc*m_total*Cp*Tevap_in - m_evap_perc*m_total*Cp*Tevap_out
    ch3_4_e['Coeff_v2_2'] = 0
    ch3_4_e['Coeff_v2_1'] = 0
    ch3_4_e['Coeff_v1_v2'] = -chiller3['ch3_totalenwkflow']['value'] * chiller3['ch3_cp']['value'] 
    ch3_4_e['Coeff_cst'] = 0
    ch3_4_e['Fmin'] = chiller3['ch3_f4']['value'] * chiller3['ch3_rated_cap']['value']
    ch3_4_e['Fmax'] = chiller3['ch3_f5']['value'] * chiller3['ch3_rated_cap']['value']
    ch3_4_e['Cost_v1_2'] = 0
    ch3_4_e['Cost_v1_1'] = 0
    ch3_4_e['Cost_v2_2'] = 0
    ch3_4_e['Cost_v2_1'] = 0
    ch3_4_e['Cost_v1_v2'] = 0
    ch3_4_e['Cost_cst'] = 0
    ch3_4_e['Cinv_v1_2'] = 0
    ch3_4_e['Cinv_v1_1'] = 0
    ch3_4_e['Cinv_v2_2'] = 0
    ch3_4_e['Cinv_v2_1'] = 0
    ch3_4_e['Cinv_v1_v2'] = 0
    ch3_4_e['Cinv_cst'] = 0
    ch3_4_e['Power_v1_2'] = 0
    ch3_4_e['Power_v1_1'] = 0
    ch3_4_e['Power_v2_2'] = 0
    ch3_4_e['Power_v2_1'] = 0
    ch3_4_e['Power_v1_v2'] = chiller3['ch3_egrad4']['value']
    ch3_4_e['Power_cst'] = chiller3['ch3_int4']['value']
    ch3_4_e['Impact_v1_2'] = 0
    ch3_4_e['Impact_v1_1'] = 0
    ch3_4_e['Impact_v2_2'] = 0
    ch3_4_e['Impact_v2_1'] = 0
    ch3_4_e['Impact_v1_v2'] = 0
    ch3_4_e['Impact_cst'] = 0

    unitinput = [ch3_4_e['Name'], ch3_4_e['Variable1'], ch3_4_e['Variable2'], ch3_4_e['Fmin_v1'], ch3_4_e['Fmax_v1'], ch3_4_e['Fmin_v2'], ch3_4_e['Fmax_v2'], ch3_4_e['Coeff_v1_2'], 
                ch3_4_e['Coeff_v1_1'], ch3_4_e['Coeff_v2_2'], ch3_4_e['Coeff_v2_1'], ch3_4_e['Coeff_v1_v2'], ch3_4_e['Coeff_cst'], ch3_4_e['Fmin'], ch3_4_e['Fmax'], ch3_4_e['Cost_v1_2'], 
                ch3_4_e['Cost_v1_1'], ch3_4_e['Cost_v2_2'], ch3_4_e['Cost_v2_1'], ch3_4_e['Cost_v1_v2'], ch3_4_e['Cost_cst'], ch3_4_e['Cinv_v1_2'], ch3_4_e['Cinv_v1_1'], ch3_4_e['Cinv_v2_2'], 
                ch3_4_e['Cinv_v2_1'], ch3_4_e['Cinv_v1_v2'], ch3_4_e['Cinv_cst'], ch3_4_e['Power_v1_2'], ch3_4_e['Power_v1_1'], ch3_4_e['Power_v2_2'], ch3_4_e['Power_v2_1'], 
                ch3_4_e['Power_v1_v2'], ch3_4_e['Power_cst'], ch3_4_e['Impact_v1_2'], ch3_4_e['Impact_v1_1'], ch3_4_e['Impact_v2_2'], ch3_4_e['Impact_v2_1'], ch3_4_e['Impact_v1_v2'], 
                ch3_4_e['Impact_cst']]   
    unitdf = pd.DataFrame(data = [unitinput], columns=['Name', 'Variable1', 'Variable2', 'Fmin_v1', 'Fmax_v1', 'Fmin_v2', 'Fmax_v2', 'Coeff_v1_2', 'Coeff_v1_1', 'Coeff_v2_2', 'Coeff_v2_1',
                                                      'Coeff_v1_v2', 'Coeff_cst', 'Fmin', 'Fmax', 'Cost_v1_2', 'Cost_v1_1', 'Cost_v2_2', 'Cost_v2_1', 'Cost_v1_v2', 'Cost_cst', 'Cinv_v1_2',
                                                      'Cinv_v1_1', 'Cinv_v2_2', 'Cinv_v2_1', 'Cinv_v1_v2', 'Cinv_cst', 'Power_v1_2', 'Power_v1_1', 'Power_v2_2', 'Power_v2_1', 'Power_v1_v2',
    ...
    ##Unit 8
    ch3_4_c = {}
    ch3_4_c['Name'] = 'ch3_4_cond'
    ch3_4_c['Variable1'] = 'm_cond_perc'                                                                                                      ##Percentage of flowrate from the entire condenser network 
    ch3_4_c['Variable2'] = 'tcond_out'                                                                                                        ##Condenser water setpoint temperature 
    ch3_4_c['Fmin_v1'] = 0 
    ch3_4_c['Fmax_v1'] = 1                                                                                                                    ##Maximum percentage is 100% 
    ch3_4_c['Fmin_v2'] = chiller3['ch3_condtin']['value'] + 1                                                                                          ##The minimum condenser exit temperature is 1 deg above entry temperature 
    ch3_4_c['Fmax_v2'] = chiller3['ch3_condtin']['value'] + 10                                                                                         ##The maximum condenser exit temperature is 10 degrees above entry temperature
    ch3_4_c['Coeff_v1_2'] = 0                                                                                                                 ##This illustrates the relationship between the variables  
    ch3_4_c['Coeff_v1_1'] = -chiller3['ch3_totalcnwkflow']['value'] * chiller3['ch3_cp']['value'] * chiller3['ch3_condtin']['value']          ##The relationship is Qc = m_cond_perc*m_total*Cp*Tcond_in - m_cond_perc*m_total*Cp*Tcond_out
    ch3_4_c['Coeff_v2_2'] = 0
    ch3_4_c['Coeff_v2_1'] = 0
    ch3_4_c['Coeff_v1_v2'] = chiller3['ch3_totalcnwkflow']['value'] * chiller3['ch3_cp']['value'] 
    ch3_4_c['Coeff_cst'] = 0
    ch3_4_c['Fmin'] = chiller3['ch3_f4']['value'] * chiller3['ch3_rated_cap']['value'] * chiller3['ch3_qc_coeff']['value']
    ch3_4_c['Fmax'] = chiller3['ch3_f5']['value'] * chiller3['ch3_rated_cap']['value'] * chiller3['ch3_qc_coeff']['value']
    ch3_4_c['Cost_v1_2'] = 0
    ch3_4_c['Cost_v1_1'] = 0
    ch3_4_c['Cost_v2_2'] = 0
    ch3_4_c['Cost_v2_1'] = 0
    ch3_4_c['Cost_v1_v2'] = 0
    ch3_4_c['Cost_cst'] = 0
    ch3_4_c['Cinv_v1_2'] = 0
    ch3_4_c['Cinv_v1_1'] = 0
    ch3_4_c['Cinv_v2_2'] = 0
    ch3_4_c['Cinv_v2_1'] = 0
    ch3_4_c['Cinv_v1_v2'] = 0
    ch3_4_c['Cinv_cst'] = 0
    ch3_4_c['Power_v1_2'] = 0
    ch3_4_c['Power_v1_1'] = 0
    ch3_4_c['Power_v2_2'] = 0
    ch3_4_c['Power_v2_1'] = 0
    ch3_4_c['Power_v1_v2'] = 0                                                                                                                ##Already accounted for in the evaporator unit
    ch3_4_c['Power_cst'] = 0
    ch3_4_c['Impact_v1_2'] = 0
    ch3_4_c['Impact_v1_1'] = 0
    ch3_4_c['Impact_v2_2'] = 0
    ch3_4_c['Impact_v2_1'] = 0
    ch3_4_c['Impact_v1_v2'] = 0
    ch3_4_c['Impact_cst'] = 0

    unitinput = [ch3_4_c['Name'], ch3_4_c['Variable1'], ch3_4_c['Variable2'], ch3_4_c['Fmin_v1'], ch3_4_c['Fmax_v1'], ch3_4_c['Fmin_v2'], ch3_4_c['Fmax_v2'], ch3_4_c['Coeff_v1_2'], ch3_4_c['Coeff_v1_1'], 
                ch3_4_c['Coeff_v2_2'], ch3_4_c['Coeff_v2_1'], ch3_4_c['Coeff_v1_v2'], ch3_4_c['Coeff_cst'], ch3_4_c['Fmin'], ch3_4_c['Fmax'], ch3_4_c['Cost_v1_2'], ch3_4_c['Cost_v1_1'], 
                ch3_4_c['Cost_v2_2'], ch3_4_c['Cost_v2_1'], ch3_4_c['Cost_v1_v2'], ch3_4_c['Cost_cst'], ch3_4_c['Cinv_v1_2'], ch3_4_c['Cinv_v1_1'], ch3_4_c['Cinv_v2_2'], ch3_4_c['Cinv_v2_1'], 
                ch3_4_c['Cinv_v1_v2'], ch3_4_c['Cinv_cst'], ch3_4_c['Power_v1_2'], ch3_4_c['Power_v1_1'], ch3_4_c['Power_v2_2'], ch3_4_c['Power_v2_1'], ch3_4_c['Power_v1_v2'], ch3_4_c['Power_cst'], 
                ch3_4_c['Impact_v1_2'], ch3_4_c['Impact_v1_1'], ch3_4_c['Impact_v2_2'], ch3_4_c['Impact_v2_1'], ch3_4_c['Impact_v1_v2'], ch3_4_c['Impact_cst']]   
    unitdf = pd.DataFrame(data = [unitinput], columns=['Name', 'Variable1', 'Variable2', 'Fmin_v1', 'Fmax_v1', 'Fmin_v2', 'Fmax_v2', 'Coeff_v1_2', 'Coeff_v1_1', 'Coeff_v2_2', 'Coeff_v2_1',
                                                      'Coeff_v1_v2', 'Coeff_cst', 'Fmin', 'Fmax', 'Cost_v1_2', 'Cost_v1_1', 'Cost_v2_2', 'Cost_v2_1', 'Cost_v1_v2', 'Cost_cst', 'Cinv_v1_2',
                                                      'Cinv_v1_1', 'Cinv_v2_2', 'Cinv_v2_1', 'Cinv_v1_v2', 'Cinv_cst', 'Power_v1_2', 'Power_v1_1', 'Power_v2_2', 'Power_v2_1', 'Power_v1_v2',
                                                      'Power_cst', 'Impact_v1_2', 'Impact_v1_1', 'Impact_v2_2', 'Impact_v2_1', 'Impact_v1_v2', 'Impact_cst'])
    ...
    stream2['Parent'] = 'ch3_1_evap'
    stream2['Type'] = 'balancing_only'
    stream2['Name'] = 'ch3_1_evap_mfout'
    stream2['Layer'] = 'chil2distnwk_flow'
    stream2['Stream_coeff_v1_2'] = 0
    stream2['Stream_coeff_v1_1'] = chiller3['ch3_totalenwkflow']['value']
    ...
    stream3['Parent'] = 'ch3_1_evap'
    stream3['Type'] = 'balancing_only'
    stream3['Name'] = 'ch3_1_evap_mfout_chk'
    stream3['Layer'] = 'chil2distnwk_flow_check'
    stream3['Stream_coeff_v1_2'] = 0
    stream3['Stream_coeff_v1_1'] = chiller3['ch3_totalenwkflow']['value']
    ...
    stream4['Parent'] = 'ch3_1_evap'
    stream4['Type'] = 'balancing_only'
    stream4['Name'] = 'ch3_1_evap_mfout_enwk'
    stream4['Layer'] = 'ch3_2_evap_flow'
    stream4['Stream_coeff_v1_2'] = 0
    stream4['Stream_coeff_v1_1'] = chiller3['ch3_totalenwkflow']['value']
    ...
    stream6['Parent'] = 'ch3_1_cond'
    stream6['Type'] = 'balancing_only'
    stream6['Name'] = 'ch3_1_cond_mfout'
    stream6['Layer'] = 'chil2condret_flow'
    stream6['Stream_coeff_v1_2'] = 0
    stream6['Stream_coeff_v1_1'] = chiller3['ch3_totalcnwkflow']['value']
    ...
    stream7['Parent'] = 'ch3_1_cond'
    stream7['Type'] = 'balancing_only'
    stream7['Name'] = 'ch3_1_cond_mfout_cnwk'
    stream7['Layer'] = 'ch3_2_cond_flow'
    stream7['Stream_coeff_v1_2'] = 0
    stream7['Stream_coeff_v1_1'] = chiller3['ch3_totalcnwkflow']['value']
    ...
    stream9['Parent'] = 'ch3_2_evap'
    stream9['Type'] = 'balancing_only'
    stream9['Name'] = 'ch3_2_evap_mfout'
    stream9['Layer'] = 'chil2distnwk_flow'
    stream9['Stream_coeff_v1_2'] = 0
    stream9['Stream_coeff_v1_1'] = chiller3['ch3_totalenwkflow']['value']
    ...
    stream10['Parent'] = 'ch3_2_evap'
    stream10['Type'] = 'balancing_only'
    stream10['Name'] = 'ch3_2_evap_mfout_chk'
    stream10['Layer'] = 'chil2distnwk_flow_check'
    stream10['Stream_coeff_v1_2'] = 0
    stream10['Stream_coeff_v1_1'] = chiller3['ch3_totalenwkflow']['value']
    ...
    stream11['Parent'] = 'ch3_2_evap'
    stream11['Type'] = 'balancing_only'
    stream11['Name'] = 'ch3_2_evap_mfout_enwk'
    stream11['Layer'] = 'ch3_2_evap_flow'
    stream11['Stream_coeff_v1_2'] = 0
    stream11['Stream_coeff_v1_1'] = chiller3['ch3_totalenwkflow']['value']
    ...
    stream13['Parent'] = 'ch3_2_cond'
    stream13['Type'] = 'balancing_only'
    stream13['Name'] = 'ch3_2_cond_mfout'
    stream13['Layer'] = 'chil2condret_flow'
    stream13['Stream_coeff_v1_2'] = 0
    stream13['Stream_coeff_v1_1'] = chiller3['ch3_totalcnwkflow']['value']
    ...
    stream14['Parent'] = 'ch3_2_cond'
    stream14['Type'] = 'balancing_only'
    stream14['Name'] = 'ch3_2_cond_mfout_cnwk'
    stream14['Layer'] = 'ch3_2_cond_flow'
    stream14['Stream_coeff_v1_2'] = 0
    stream14['Stream_coeff_v1_1'] = chiller3['ch3_totalcnwkflow']['value']
    ...
    stream16['Parent'] = 'ch3_3_evap'
    stream16['Type'] = 'balancing_only'
    stream16['Name'] = 'ch3_3_evap_mfout'
    stream16['Layer'] = 'chil2distnwk_flow'
    stream16['Stream_coeff_v1_2'] = 0
    stream16['Stream_coeff_v1_1'] = chiller3['ch3_totalenwkflow']['value']
    ...
    stream17['Parent'] = 'ch3_3_evap'
    stream17['Type'] = 'balancing_only'
    stream17['Name'] = 'ch3_3_evap_mfout_chk'
    stream17['Layer'] = 'chil2distnwk_flow_check'
    stream17['Stream_coeff_v1_2'] = 0
    stream17['Stream_coeff_v1_1'] = chiller3['ch3_totalenwkflow']['value']
    ...
    stream18['Parent'] = 'ch3_3_evap'
    stream18['Type'] = 'balancing_only'
    stream18['Name'] = 'ch3_3_evap_mfout_enwk'
    stream18['Layer'] = 'ch3_2_evap_flow'
    stream18['Stream_coeff_v1_2'] = 0
    stream18['Stream_coeff_v1_1'] = chiller3['ch3_totalenwkflow']['value']
    ...
    stream20['Parent'] = 'ch3_3_cond'
    stream20['Type'] = 'balancing_only'
    stream20['Name'] = 'ch3_3_cond_mfout'
    stream20['Layer'] = 'chil2condret_flow'
    stream20['Stream_coeff_v1_2'] = 0
    stream20['Stream_coeff_v1_1'] = chiller3['ch3_totalcnwkflow']['value']
    ...
    stream21['Parent'] = 'ch3_3_cond'
    stream21['Type'] = 'balancing_only'
    stream21['Name'] = 'ch3_3_cond_mfout_cnwk'
    stream21['Layer'] = 'ch3_2_cond_flow'
    stream21['Stream_coeff_v1_2'] = 0
    stream21['Stream_coeff_v1_1'] = chiller3['ch3_totalcnwkflow']['value']
    ...
    stream23['Parent'] = 'ch3_4_evap'
    stream23['Type'] = 'balancing_only'
    stream23['Name'] = 'ch3_4_evap_mfout'
    stream23['Layer'] = 'chil2distnwk_flow'
    stream23['Stream_coeff_v1_2'] = 0
    stream23['Stream_coeff_v1_1'] = chiller3['ch3_totalenwkflow']['value']
    ...
    stream24['Parent'] = 'ch3_4_evap'
    stream24['Type'] = 'balancing_only'
    stream24['Name'] = 'ch3_4_evap_mfout_chk'
    stream24['Layer'] = 'chil2distnwk_flow_check'
    stream24['Stream_coeff_v1_2'] = 0
    stream24['Stream_coeff_v1_1'] = chiller3['ch3_totalenwkflow']['value']
    ...
    stream25['Parent'] = 'ch3_4_evap'
    stream25['Type'] = 'balancing_only'
    stream25['Name'] = 'ch3_4_evap_mfout_enwk'
    stream25['Layer'] = 'ch3_2_evap_flow'
    stream25['Stream_coeff_v1_2'] = 0
    stream25['Stream_coeff_v1_1'] = chiller3['ch3_totalenwkflow']['value']
    ...
    stream27['Parent'] = 'ch3_4_cond'
    stream27['Type'] = 'balancing_only'
    stream27['Name'] = 'ch3_4_cond_mfout'
    stream27['Layer'] = 'chil2condret_flow'
    stream27['Stream_coeff_v1_2'] = 0
    stream27['Stream_coeff_v1_1'] = chiller3['ch3_totalcnwkflow']['value']
    ...
    stream28['Parent'] = 'ch3_4_cond'
    stream28['Type'] = 'balancing_only'
    stream28['Name'] = 'ch3_4_cond_mfout_cnwk'
    stream28['Layer'] = 'ch3_2_cond_flow'
    stream28['Stream_coeff_v1_2'] = 0
    stream28['Stream_coeff_v1_1'] = chiller3['ch3_totalcnwkflow']['value']
    ...
    ##Equation 1
    eqn1 = {}
    eqn1['Name'] = 'ch3_1_evap_cond_link'
    eqn1['Type'] = 'unit_link'
    eqn1['Sign'] = 'equal_to'
    eqn1['RHS_value'] = 0
    ...
    ##Equation 2
    eqn2 = {}
    eqn2['Name'] = 'ch3_2_evap_cond_link'
    eqn2['Type'] = 'unit_link'
    eqn2['Sign'] = 'equal_to'
    eqn2['RHS_value'] = 0
    ...
    ##Equation 3
    eqn3 = {}
    eqn3['Name'] = 'ch3_3_evap_cond_link'
    eqn3['Type'] = 'unit_link'
    eqn3['Sign'] = 'equal_to'
    eqn3['RHS_value'] = 0
    ...
    ##Equation 4
    eqn4 = {}
    eqn4['Name'] = 'ch3_4_evap_cond_link'
    eqn4['Type'] = 'unit_link'
    eqn4['Sign'] = 'equal_to'
    eqn4['RHS_value'] = 0
    ...
    ##Term 1 
    term1 = {}
    term1['Parent_unit'] = 'ch3_1_evap'
    term1['Parent_eqn'] = 'ch3_1_evap_cond_link'
    term1['Parent_stream'] = '-'                                    ##Only applicable for stream_limit types  
    term1['Coefficient'] = chiller3['ch3_qc_coeff']['value']
    ...
    ##Term 2
    term2 = {}
    term2['Parent_unit'] = 'ch3_1_cond'
    term2['Parent_eqn'] = 'ch3_1_evap_cond_link'
    ...
    ##Term 3 
    term3 = {}
    term3['Parent_unit'] = 'ch3_2_evap'
    term3['Parent_eqn'] = 'ch3_2_evap_cond_link'
    term3['Parent_stream'] = '-'                                    ##Only applicable for stream_limit types  
    term3['Coefficient'] = chiller3['ch3_qc_coeff']['value']
    ...
    ##Term 4
    term4 = {}
    term4['Parent_unit'] = 'ch3_2_cond'
    term4['Parent_eqn'] = 'ch3_2_evap_cond_link'
    ...
    ##Term 5 
    term5 = {}
    term5['Parent_unit'] = 'ch3_3_evap'
    term5['Parent_eqn'] = 'ch3_3_evap_cond_link'
    term5['Parent_stream'] = '-'                                    ##Only applicable for stream_limit types  
    term5['Coefficient'] = chiller3['ch3_qc_coeff']['value']
    ...
    ##Term 6
    term6 = {}
    term6['Parent_unit'] = 'ch3_3_cond'
    term6['Parent_eqn'] = 'ch3_3_evap_cond_link'
    ...
    ##Term 7 
    term7 = {}
    term7['Parent_unit'] = 'ch3_4_evap'
    term7['Parent_eqn'] = 'ch3_4_evap_cond_link'
    term7['Parent_stream'] = '-'                                    ##Only applicable for stream_limit types  
    term7['Coefficient'] = chiller3['ch3_qc_coeff']['value']
    ...
    ##Term 8
    term8 = {}
    term8['Parent_unit'] = 'ch3_4_cond'
    term8['Parent_eqn'] = 'ch3_4_evap_cond_link'
    ...
    ##Term 9
    term9 = {}
    term9['Parent_unit'] = 'ch3_1_evap'
    term9['Parent_eqn'] = 'totaluse_ch3'
    ...
    ##Term 10
    term10 = {}
    term10['Parent_unit'] = 'ch3_2_evap'
    term10['Parent_eqn'] = 'totaluse_ch3'
    ...
    ##Term 11
    term11 = {}
    term11['Parent_unit'] = 'ch3_3_evap'
    term11['Parent_eqn'] = 'totaluse_ch3'
    ...
    ##Term 12
    term12 = {}
    term12['Parent_unit'] = 'ch3_4_evap'
    term12['Parent_eqn'] = 'totaluse_ch3'
