...
def checktype_customer_1_cm (unit_type):                  ##Input the unit type here
    unit_type = 'utility'
    return unit_type 
    
def customer_1_cm (cust_1_cm_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    from customer_1_cm_compute import customer_1_cm_compute
    import pandas as pd
    import numpy as np 
...
############################################################################################################################################################################################################
    ...
    ##Stream 1
    stream = {}                                                                
    stream['Parent'] = 'gv2_ss_4nc'                                                ##Temperature stream entering the substation 
    stream['Type'] = 'temp_chil'
    stream['Name'] = 'gv2_ss_4nc_tin'
    ...
    ##Stream 2
    stream = {}                                                                
    stream['Parent'] = 'gv2_ss_4nc'                                                ##Flowrate stream entering the substation 
    stream['Type'] = 'flow'
    stream['Name'] = 'gv2_ss_4nc_mfin'
