...
def cvx_prog_run_nwk_4(parallel_thread_num):
    ...
    slave_models_location = 'C:\\Optimization_zlc\\slave_level_models\\slave_convex_vtest2\\nwk_choice_4\\'
    ##Bilinear pieces
    bilinear_pieces = 2
    ...
    ##File 3
    inputmodel = pd.DataFrame(data = ['chiller1_ret_nwk_choice_4'], columns = ['Filename'])                ##gv2_substation 
    files = files.append(inputmodel, ignore_index=True)        
