...
def checktype_pfa_substation (unit_type):                  ##Input the unit type here
    unit_type = 'utility'
    return unit_type 
...
def pfa_substation (pfa_ss_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    ...
    pfa_ss_demand = pfa_ss_mdv['Value'][0]
    pfa_ss_totalflownwk = pfa_ss_mdv['Value'][1]
    ...
    ##Stream 4
    stream = {}                                                                
    stream['Parent'] = 'pfa_ss'                                                ##Flowrate out to the distribution pump
    stream['Type'] = 'flow'
    stream['Name'] = 'pfa_ss_flow_out'
