...
def chiller2 (ch2_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    ...
    ##This is the chiller2 model, it is simplified by having 
    ...
    ch2_twb = ch2_mdv['Value'][0]                           ##The associated thermodynamic wetbulb temperature 
    ch2_steps = ch2_mdv['Value'][1]                         ##The number of piecewise linear pieces
    ch2_time_dependent_elect_tariff = ch2_mdv['Value'][2]   ##Time dependent electricity tariff per kWh used. 
    
    ##Defined constants 
    ch2_rated_cap = 7330                                    ##Rated capacity of the chiller
    ch2_tevap_out = 5 + 273.15                              ##Chiller supply temperature
    ch2_delt_evap = 5                                       ##Temperature difference at the evaporator side
    ch2_delt_cond = 5                                       ##Temperature difference at the condenser side
    ch2_b0 = 1.35049420632748                               ##Chiller regression derived coefficients
    ch2_b1 = -134.853705222833
    ch2_b2 = 0.00430128306723068
    ch2_qc_coeff = 1.10348067074030
    ch2_cp = 4.2                                            ##Specific heat of water
    ch2_evap_nwk_coeff = 3.07492E-05
    ch2_cond_nwk_coeff = 0.000017825112553599
   
    ##Calling a compute file to process dependent values
        ##Placing the values in a numpy array for easy data handling 
    ch2_dc = np.zeros((13, 1))
    ch2_dc[0,0] = ch2_twb
    ch2_dc[1,0] = ch2_rated_cap
    ch2_dc[2,0] = ch2_b0
    ch2_dc[3,0] = ch2_b1
    ch2_dc[4,0] = ch2_b2
    ch2_dc[5,0] = ch2_qc_coeff
    ch2_dc[6,0] = ch2_steps
    ch2_dc[7,0] = ch2_tevap_out
    ch2_dc[8,0] = ch2_delt_evap
    ch2_dc[9,0] = ch2_delt_cond
    ch2_dc[10,0] = ch2_evap_nwk_coeff
    ch2_dc[11,0] = ch2_cp
    ch2_dc[12,0] = ch2_cond_nwk_coeff

    ch2_ret_vals, ch2_evap_nwk_ret_vals, ch2_cond_nwk_ret_vals = chiller2_compute(ch2_dc)
...
#################################################################################################################################################################################################        
    ...
    for i in range (0, int(ch2_steps)):
        ud = {}
        ud['Name'] = 'ch2_' + str(i + 1)
        ud['Variable1'] = 'q_out'                                              
        ud['Variable2'] = '-'                                                
        ud['Fmin_v1'] = ch2_ret_vals['lb'][i] * ch2_rated_cap
        ud['Fmax_v1'] = ch2_ret_vals['ub'][i] * ch2_rated_cap                                                                                             
        ud['Fmin_v2'] = '-'                                                                                              
        ud['Fmax_v2'] = '-'                                                                                       
        ud['Coeff_v1_2'] = 0                                                                                             
        ud['Coeff_v1_1'] = 0
        ...
        ud['Fmax'] = 0
        ud['Cost_v1_2'] = 0
        ud['Cost_v1_1'] = ch2_time_dependent_elect_tariff * ch2_ret_vals['grad'][i]
        ud['Cost_v2_2'] = 0
        ud['Cost_v2_1'] = 0
        ud['Cost_v1_v2'] = 0
        ud['Cost_cst'] = ch2_time_dependent_elect_tariff * ch2_ret_vals['int'][i]
        ud['Cinv_v1_2'] = 0
        ud['Cinv_v1_1'] = 0
        ud['Cinv_v2_2'] = 0
        ud['Cinv_v2_1'] = 0
        ...
        ud['Cinv_cst'] = 0
        ud['Power_v1_2'] = 0
        ud['Power_v1_1'] = ch2_ret_vals['grad'][i]
        ud['Power_v2_2'] = 0
        ud['Power_v2_1'] = 0
        ud['Power_v1_v2'] = 0
...
####################################################################################################################################################################################################        
    ...
    for i in range (0, int(ch2_steps)):
        ...
        ##Stream --- cooling out
        stream = {}                                                                
        stream['Parent'] = 'ch2_' + str(i + 1)
        stream['Type'] = 'flow'
        stream['Name'] = 'ch2_' + str(i + 1) + '_q_out'
        ...
        stream['Parent'] = 'ch2_' + str(i + 1)
        stream['Type'] = 'flow'
        stream['Name'] = 'ch2_' + str(i + 1) + '_heatrej'
        stream['Layer'] = 'chiller_heat_rej'
        stream['Stream_coeff_v1_2'] = 0
        stream['Stream_coeff_v1_1'] = (ch2_dc[5,0] * ch2_ret_vals['grad'][i]) + (ch2_dc[5,0]) 
        stream['Stream_coeff_v2_2'] = 0
        stream['Stream_coeff_v2_1'] = 0
        stream['Stream_coeff_v1_v2'] = 0
        stream['Stream_coeff_cst'] = ch2_ret_vals['int'][i] * ch2_dc[5,0]
        stream['InOut'] = 'out'
        ...
        stream['Parent'] = 'ch2_' + str(i + 1)
        stream['Type'] = 'flow'
        stream['Name'] = 'ch2_' + str(i + 1) + '_flow_ep'
        stream['Layer'] = 'chiller2_flow_evap_pump'
        stream['Stream_coeff_v1_2'] = 0
        stream['Stream_coeff_v1_1'] = 3600 / (998.2 * ch2_cp * ch2_dc[8,0])
        stream['Stream_coeff_v2_2'] = 0
        stream['Stream_coeff_v2_1'] = 0
        stream['Stream_coeff_v1_v2'] = 0
        stream['Stream_coeff_cst'] = 0
        ...
        stream['Name'] = 'ch2_' + str(i + 1) + '_pressure_flow_ep'
        stream['Layer'] = 'e_nwk_2_ep2'
        stream['Stream_coeff_v1_2'] = 0
        stream['Stream_coeff_v1_1'] = (3600 / (998.2 * ch2_cp * ch2_dc[8,0])) * ch2_evap_nwk_ret_vals['grad'][i]
        stream['Stream_coeff_v2_2'] = 0
        stream['Stream_coeff_v2_1'] = 0
        stream['Stream_coeff_v1_v2'] = 0
        stream['Stream_coeff_cst'] = ch2_evap_nwk_ret_vals['int'][i]
        stream['InOut'] = 'out'
        ...
        stream['Parent'] = 'ch2_' + str(i + 1)
        stream['Type'] = 'flow'
        stream['Name'] = 'ch2_' + str(i + 1) + '_flow_cp'
        stream['Layer'] = 'chiller2_flow_cond_pump'
        stream['Stream_coeff_v1_2'] = 0
        stream['Stream_coeff_v1_1'] = (3600 * ((ch2_dc[5,0] * ch2_ret_vals['grad'][i]) + ch2_dc[5,0])) / (998.2 * ch2_cp * ch2_dc[9,0])
        stream['Stream_coeff_v2_2'] = 0
        stream['Stream_coeff_v2_1'] = 0
        stream['Stream_coeff_v1_v2'] = 0
        stream['Stream_coeff_cst'] = (3600 * ch2_dc[5,0] * ch2_ret_vals['int'][i]) / (998.2 * ch2_cp * ch2_dc[9,0])
        stream['InOut'] = 'out'
        ...
        stream['Parent'] = 'ch2_' + str(i + 1)
        stream['Type'] = 'pressure'
        stream['Name'] = 'ch2_' + str(i + 1) + 'pressure_flow_cp'
        stream['Layer'] = 'c_nwk_2_cp2'
        stream['Stream_coeff_v1_2'] = 0
        stream['Stream_coeff_v1_1'] = ch2_cond_nwk_ret_vals['grad'][i] * ((3600 * ((ch2_dc[5,0] * ch2_ret_vals['grad'][i]) + ch2_dc[5,0])) / (998.2 * ch2_cp * ch2_dc[9,0]))
        stream['Stream_coeff_v2_2'] = 0
        stream['Stream_coeff_v2_1'] = 0
        stream['Stream_coeff_v1_v2'] = 0
        stream['Stream_coeff_cst'] = (ch2_cond_nwk_ret_vals['grad'][i] * (3600 * ch2_dc[5,0] * ch2_ret_vals['int'][i]) / (998.2 * ch2_cp * ch2_dc[9,0])) + ch2_cond_nwk_ret_vals['int'][i]
        stream['InOut'] = 'out'
        ...
        stream['Parent'] = 'ch2_' + str(i + 1)
        stream['Type'] = 'flow'
        stream['Name'] = 'ch2_' + str(i + 1) + '_flow_enwk'
        ...
        stream['Parent'] = 'ch2_' + str(i + 1)
        stream['Type'] = 'flow'
        stream['Name'] = 'ch2_' + str(i + 1) + '_flow_cnwk'
