...
def sorting_linear_and_bilinear_terms (layerslist, utilitylist, processlist, streams, cons_eqns, cons_eqns_terms, obj_func, bilinear_pieces):
    ...
    affected_list = detect_bilinear_variables (utilitylist, processlist, streams, cons_eqns_terms, obj_func)
...
def generate_linear_lists ():
    ...
    return utilitylist_linear, processlist_linear, streams_linear, cons_eqns_linear, cons_eqns_terms_linear
