...
def extract_and_process_values (ret_dataframes, utility_list, process_list, bilinear_pieces, solver_choice, parallel_thread_num, affected_list):
    ...
    if solver_choice == 'gurobi':
        obj_value, results, results_y = extract_gurobi_results(utility_list, process_list, bilinear_pieces, parallel_thread_num)
...
def extract_gurobi_results (utility_list, process_list, bilinear_pieces, parallel_thread_num):
