...
def chiller2 (mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    ...
    ch2_evap_ret_temp = mdv['Value'][0]
    ch2_ctin = mdv['Value'][1]
    ch2_tenwkflow = mdv['Value'][2]                    ##Total flowrate through all evaporators of all chillers  
    ch2_steps = mdv['Value'][3]                        ##The number of piecewise linear pieces
...
####################################################################################################################################################################################################        
    ...
    for i in range (0, int(ch2_steps)):
        ...
        stream['Name'] = 'ch2_' + str(i + 1) + '_tout'
        ...
        stream['Parent'] = 'ch2_' + str(i + 1)
        stream['Type'] = 'flow'
        stream['Name'] = 'ch2_' + str(i + 1) + '_mfout'
