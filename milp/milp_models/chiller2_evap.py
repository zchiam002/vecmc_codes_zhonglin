...
def checktype_chiller2_evap_4nc (unit_type):                  ##Input the unit type here
    unit_type = 'utility'
    return unit_type

def chiller2_evap_4nc (ch2_4nc_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    from chiller2_evap_4nc_compute import chiller2_evap_4nc_compute
    import pandas as pd
    import numpy as np
    
    ##This is the evaporator side of chiller2_evap_4nc
    ...
    ##ch2_4nc_mdv --- the master decision variables which are used as parameters at this stage 
    ...
    ch2_4nc_evap_ret_temp = ch2_4nc_mdv['Value'][0]
    ch2_4nc_ctin = ch2_4nc_mdv['Value'][1]
    ch2_4nc_tenwkflow = ch2_4nc_mdv['Value'][2]                    ##Total flowrate through all evaporators of all chillers  
    ch2_4nc_steps = ch2_4nc_mdv['Value'][3]                        ##The number of piecewise linear pieces
    
    ##Defined constants 
    ch2_4nc_rated_cap = 7330
    ch2_4nc_b0 = 1.35049420632748
    ch2_4nc_b1 = -134.853705222833
    ch2_4nc_b2 = 0.00430128306723068
    ch2_4nc_qc_coeff = 1.10348067074030
    ch2_4nc_cp = 4.2
    ch2_4nc_min_flow = 0.5 * 820.4531779
    
    ##Calling a compute file to process dependent values
        ##Placing the values in a numpy array for easy data handling 
    ch2_4nc_dc = np.zeros((10, 1))
    ch2_4nc_dc[0,0] = ch2_4nc_evap_ret_temp
    ch2_4nc_dc[1,0] = ch2_4nc_ctin
    ch2_4nc_dc[2,0] = ch2_4nc_rated_cap
    ch2_4nc_dc[3,0] = ch2_4nc_b0
    ch2_4nc_dc[4,0] = ch2_4nc_b1
    ch2_4nc_dc[5,0] = ch2_4nc_b2
    ch2_4nc_dc[6,0] = ch2_4nc_qc_coeff
    ch2_4nc_dc[7,0] = ch2_4nc_tenwkflow
    ch2_4nc_dc[8,0] = ch2_4nc_steps
    
    ch2_4nc_ret_vals = chiller2_evap_4nc_compute(ch2_4nc_dc)
    
#################################################################################################################################################################################################        
    ##Unit definition 
    
    ##Evaporator stepwise
    for i in range (0, int(ch2_4nc_steps)):
        ud = {}
        ud['Name'] = 'ch2_4nc_' + str(i + 1) + '_evap'
        ...
        ud['Coeff_v1_1'] = ((ch2_4nc_tenwkflow * ch2_4nc_cp * 998.2 * (ch2_4nc_evap_ret_temp - 273.15 - 1) / 3600))     ##The relationship is Qe = m_evap_perc*m_total*Cp*Tevap_in - m_evap_perc*m_total*Cp*Tevap_out
        ud['Coeff_v2_2'] = 0
        ud['Coeff_v2_1'] = 0
        ud['Coeff_v1_v2'] = -((ch2_4nc_tenwkflow * ch2_4nc_cp * 998.2 * (ch2_4nc_evap_ret_temp - 273.15 - 1)/ 3600)) 
        ud['Coeff_cst'] = 0
        ud['Fmin'] = ch2_4nc_ret_vals['lb'][i] * ch2_4nc_rated_cap
        ud['Fmax'] = ch2_4nc_ret_vals['ub'][i] * ch2_4nc_rated_cap
        ud['Cost_v1_2'] = 0
        ud['Cost_v1_1'] = 0
        ud['Cost_v2_2'] = 0
        ud['Cost_v2_1'] = 0
        ...
        ud['Cinv_cst'] = 0
        ud['Power_v1_2'] = 0
        ud['Power_v1_1'] = (ch2_4nc_ret_vals['grad'][i] * ch2_4nc_tenwkflow * 4.2 * (ch2_4nc_evap_ret_temp - 273.15 - 1) * 998.2 / 3600)
        ud['Power_v2_2'] = 0
        ud['Power_v2_1'] = 0
        ud['Power_v1_v2'] = -(ch2_4nc_ret_vals['grad'][i] * ch2_4nc_tenwkflow * 4.2 * (ch2_4nc_evap_ret_temp - 273.15 - 1) * 998.2 / 3600)
        ud['Power_cst'] = ch2_4nc_ret_vals['int'][i]
        ud['Impact_v1_2'] = 0
        ud['Impact_v1_1'] = 0
        ud['Impact_v2_2'] = 0
        ud['Impact_v2_1'] = 0
...
####################################################################################################################################################################################################        
    ...
    for i in range (0, int(ch2_4nc_steps)):
        ...
        ##Stream --- temperature 
        stream = {}                         
        stream['Parent'] = 'ch2_4nc_' + str(i + 1) + '_evap'
        stream['Type'] = 'temp_chil'
        stream['Name'] = 'ch2_4nc_' + str(i + 1) + '_evap_tout'
        ...
        stream['Stream_coeff_v1_v2'] = (ch2_4nc_evap_ret_temp - 273.15 - 1)
        ...
        stream['Parent'] = 'ch2_4nc_' + str(i + 1) + '_evap'
        stream['Type'] = 'flow'
        stream['Name'] = 'ch2_4nc_' + str(i + 1) + '_evap_mfout'
        stream['Layer'] = 'ch2_2_ch2evapnwk_flow' 
        stream['Stream_coeff_v1_2'] = 0
        stream['Stream_coeff_v1_1'] = ch2_4nc_tenwkflow 
        stream['Stream_coeff_v2_2'] = 0
        stream['Stream_coeff_v2_1'] = 0
        ...
        stream['Name'] = 'ch2_4nc_' + str(i + 1) + '_evap_energyout'
        stream['Layer'] = 'ch2_evap2cond'
        stream['Stream_coeff_v1_2'] = 0
        stream['Stream_coeff_v1_1'] = ((ch2_4nc_tenwkflow * ch2_4nc_cp * 998.2 * (ch2_4nc_evap_ret_temp - 273.15 - 1) / 3600)) + (ch2_4nc_ret_vals['grad'][i] * ch2_4nc_tenwkflow * 4.2 * (ch2_4nc_evap_ret_temp - 273.15 - 1) * 998.2 / 3600)
        stream['Stream_coeff_v2_2'] = 0
        stream['Stream_coeff_v2_1'] = 0
        stream['Stream_coeff_v1_v2'] = -((ch2_4nc_tenwkflow * ch2_4nc_cp * 998.2 * (ch2_4nc_evap_ret_temp - 273.15 - 1)/ 3600)) - (ch2_4nc_ret_vals['grad'][i] * ch2_4nc_tenwkflow * 4.2 * (ch2_4nc_evap_ret_temp - 273.15 - 1) * 998.2 / 3600)
        stream['Stream_coeff_cst'] = ch2_4nc_ret_vals['int'][i]
        stream['InOut'] = 'out'
...
############################################################################################################################################################################################################
    ...
    eqn = {}
    eqn['Name'] = 'totaluse_ch2_e_c_4nc'                                        ##To make sure that if the evaporator is operated, the condenser is also
    eqn['Type'] = 'unit_binary'
    eqn['Sign'] = 'equal_to'
    eqn['RHS_value'] = 0
    ...
    for i in range (0, int(ch2_4nc_steps)):   
        term = {}
        term['Parent_unit'] = 'ch2_4nc_' + str(i + 1) + '_evap'
        term['Parent_eqn'] = 'totaluse_ch2_e_4nc'
        ...
        term = {}
        term['Parent_unit'] = 'ch2_4nc_' + str(i + 1) + '_evap'
        term['Parent_eqn'] = 'ch2_e_4nc_flow_min'
        term['Parent_stream'] = '-'                                    ##Only applicable for stream_limit types 
        term['Coefficient'] = 0
        term['Coeff_v1_2'] = 0                                         ##Only applicable for stream_limit_modified types 
        term['Coeff_v1_1'] = ch2_4nc_tenwkflow
        term['Coeff_v2_2'] = 0
        term['Coeff_v2_1'] = 0
        term['Coeff_v1_v2'] = 0
        term['Coeff_cst'] = -ch2_4nc_min_flow
        ...
        term = {}
        term['Parent_unit'] = 'ch2_4nc_' + str(i + 1) + '_evap'
        term['Parent_eqn'] = 'totaluse_ch2_e_c_4nc'
        term['Parent_stream'] = '-'                                    ##Only applicable for stream_limit types 
        term['Coefficient'] = 1
        term['Coeff_v1_2'] = 0                                         ##Only applicable for stream_limit_modified types 
        term['Coeff_v1_1'] = 0
