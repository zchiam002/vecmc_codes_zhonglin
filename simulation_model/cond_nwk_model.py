##This is the condenser network model 

def cond_nwk_org (chiller_input, chiller_onoff):
    import sys
    ...
    ##Flow limits 
    ch1_cond_nwk_flow_limit = 600
    ch2_cond_nwk_flow_limit = 2000    
    ch3_cond_nwk_flow_limit = 2000
    ...
    if chiller_onoff['chiller1_onoff'] == 1:    
        ...
        return_values['Chiller1_cond_pump_delp'] = 0
        return_values['Chiller1_cond_pump_max_flow'] = 0
        return_values['Chiller1_cond_pump_elect_cons'] = 0        
    ...
    if chiller_onoff['chiller2_onoff'] == 1:          
        ...
        return_values['Chiller2_cond_pump_delp'] = 0
        return_values['Chiller2_cond_pump_max_flow'] = 0
        return_values['Chiller2_cond_pump_elect_cons'] = 0    
    ...
    if chiller_onoff['chiller3_onoff'] == 1:          
        ...
        return_values['Chiller3_cond_pump_delp'] = 0
        return_values['Chiller3_cond_pump_max_flow'] = 0
        return_values['Chiller3_cond_pump_elect_cons'] = 0         
