...
def main_a2c_function ():
    ...
    #actor_hidden_layers = [400, 400, 100]
    actor_lr = 0.0001
    actor_output_bounds = {}
    ...
    #critic_hidden_layers = [500, 500, 400, 100]
    critic_lr = 0.00001
    ...
    offline_trace_folder = current_directory + 'control_center\\chiller_optimization_dist_nwk_a2c\\batch_training_data\\seeding_values\\'
    ...
    save_folder_directory = current_directory + 'master_level\\reinforcement_learning_algorithm\\actor_critic_advantage_milp\\saved_model\\'
...
#############################################################################################################################################################################
    ...
    trained_model_directory = current_directory + 'master_level//reinforcement_learning_algorithm//actor_critic_advantage_milp//saved_model//'
    trained_model_save_file_name = './a2c_trained.ckpt'
    trained_model_save_dir = trained_model_directory + trained_model_save_file_name
    
    vali_saved_dir = current_directory + 'control_center//chiller_optimization_dist_nwk_a2c//vali_folder_1//'
