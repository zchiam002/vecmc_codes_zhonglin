##This function creates the actor advantage network 
    ##It inputs the state 
    ##Outputs 2 values 
...
def actor_advantage_function (state_placeholder, hidden_layer_neurons, output_dimension, env_action_ub_lb):
    ...
    with tf.variable_scope('actor_advantage_network'):
