...
def prepare_dist_nwk_lin_coeff ():
    ...
    import sys 
    sys.path.append(current_directory + 'add_ons//')
    ...
    all_combi_dist_pump_lin_coeff.to_csv(current_directory + 'look_up_tables//dist_pump_lincoeff.csv')
    all_combi_dist_pump_press_coeff.to_csv(current_directory + 'look_up_tables//dist_pump_presscoeff.csv')
    return 
