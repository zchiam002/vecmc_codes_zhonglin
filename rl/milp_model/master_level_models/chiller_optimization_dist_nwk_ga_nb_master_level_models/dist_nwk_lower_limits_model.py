...
def dist_nwk_lower_limits_model ():
    ...
    ice_main_coeff = 0.0000104227119644958
    gv2_coeff = 0.0000735647190189052
    hsb_coeff = 0.0075648885553576
    tro_main_coeff = 0.00043901081005616
    pfa_coeff = 0.00021850538714815
    ser_coeff = 0.000536956604603528
    fir_coeff = 0.00372496074197394
    ...
    max_flow = 100
    coeff_x2, coeff_x = convert_to_quadratic(fir_coeff, max_flow)
