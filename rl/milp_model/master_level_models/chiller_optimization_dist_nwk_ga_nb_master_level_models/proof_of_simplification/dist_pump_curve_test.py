...
import os
current_directory = os.path.dirname(__file__)[:-100] + '//'  
import sys
sys.path.append(current_directory + 'master_level_models\\chiller_optimization_dist_nwk_ga_nb_master_level_models\\proof_of_simplification\\')
