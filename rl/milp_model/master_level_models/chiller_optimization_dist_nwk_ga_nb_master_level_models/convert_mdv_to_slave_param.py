...
def convert_mdv_to_slave_param_v2 (thread_number, var, demand, weather_and_ct_coeff, piecewise_steps):
    ...
    import sys 
    sys.path.append(current_directory + 'master_level_models\\\chiller_optimization_dist_nwk_ga_nb_master_level_models\\prep_functions\\')
    import os.path
    ...
    csv_save_loc = current_directory + 'slave_convex_handlers\\master_values\\'
