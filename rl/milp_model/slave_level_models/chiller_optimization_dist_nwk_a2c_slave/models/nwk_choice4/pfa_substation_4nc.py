...
def pfa_substation_4nc (pfa_ss_4nc_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    ...
    ##Stream 1
    stream = {}                                                                
    stream['Parent'] = 'pfa_ss_4nc'                                                ##Temperature stream entering the substation 
    stream['Type'] = 'temp_chil'
    stream['Name'] = 'pfa_ss_4nc_tin'
    ...
    ##Stream 2
    stream = {}                                                                
    stream['Parent'] = 'pfa_ss_4nc'                                                ##Flowrate stream entering the substation 
    stream['Type'] = 'flow'
    stream['Name'] = 'pfa_ss_4nc_mfin'
