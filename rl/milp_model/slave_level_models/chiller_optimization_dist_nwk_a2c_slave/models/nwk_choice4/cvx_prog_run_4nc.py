...
def cvx_prog_run_4nc(parallel_thread_num, bilinear_pieces, solver_choice):
    ...
    import sys 
    sys.path.append(current_directory + 'milp_model//slave_convex_handlers//')
    from slave_convex_backend import slave_convex_backend
    import pandas as pd 
    

    slave_models_location = current_directory + 'milp_model//slave_level_models\\chiller_optimization_dist_nwk_a2c_slave\\models\\nwk_choice4\\'
