...
def checktype_hsb_substation_4nc (unit_type):                  ##Input the unit type here
    unit_type = 'utility'
    return unit_type 
    
def hsb_substation_4nc (hsb_ss_4nc_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    from hsb_substation_4nc_compute import hsb_substation_4nc_compute
    import pandas as pd
    import numpy as np 
    ...
    hsb_ss_demand = hsb_ss_4nc_mdv['Value'][0]
    hsb_ss_totalflownwk = hsb_ss_4nc_mdv['Value'][1]
    ...
    hsb_ss_calc = hsb_substation_4nc_compute(hsb_ss_dc)
    ...
    ##Stream 1
    stream = {}                                                                
    stream['Parent'] = 'hsb_ss_4nc'                                                ##Temperature stream entering the substation 
    stream['Type'] = 'temp_chil'
    stream['Name'] = 'hsb_ss_4nc_tin'
    ...
    ##Stream 2
    stream = {}                                                                
    stream['Parent'] = 'hsb_ss_4nc'                                                ##Flowrate stream entering the substation 
    stream['Type'] = 'flow'
    stream['Name'] = 'hsb_ss_4nc_mfin'
    ...
    ##Stream 3
    stream = {}                                                                
    stream['Parent'] = 'hsb_ss_4nc'                                                ##Temperture stream exiting the substation 
    stream['Type'] = 'temp_chil'
    stream['Name'] = 'hsb_ss_4nc_tout'
    ...
    ##Stream 4
    stream = {}                                                                
    stream['Parent'] = 'hsb_ss_4nc'                                                ##Flowrate out to the distribution pump
    stream['Type'] = 'flow'
    stream['Name'] = 'hsb_ss_4nc_flow_out'
    ...
    ##Term 1
    term = {}
    term['Parent_unit'] = 'hsb_ss_4nc'
    term['Parent_eqn'] = 'hsb_ss_4nc_tout_max'
