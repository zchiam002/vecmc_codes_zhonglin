...
def chiller3_evap_pump_4nc (ch3_ep_4nc_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    ...
    import numpy as np
    import os
    current_path_basic = os.path.dirname(__file__)[:-32] + '//'
    ...
    ch3_ep_p_look_up_table_loc = current_path_basic + 'milp_model//master_level_models//look_up_tables//'      ##Evaporator pump look up table location 
