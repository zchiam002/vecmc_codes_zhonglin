...
def checktype_ser_substation_4nc (unit_type):                  ##Input the unit type here
    unit_type = 'utility'
    return unit_type 
    
def ser_substation_4nc (ser_ss_4nc_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    from ser_substation_4nc_compute import ser_substation_4nc_compute
    import pandas as pd
    import numpy as np 
    ...
    ser_ss_demand = ser_ss_4nc_mdv['Value'][0]
    ser_ss_totalflownwk = ser_ss_4nc_mdv['Value'][1]


    ##Defined constants
    ser_ss_tinmax  = 273.15 + 5       ##The maximum temperature of water entering the substation 
    ser_ss_deltmax  = 7               ##The maximum delta t of the substation on the cold side  (value based on ser)
    ser_ss_cp = 4.2                   ##The heat capacity of water 

    ##Dependent constants 
    ser_ss_dc = np.zeros((5,1))                                 ##Initialize the list, note the number of constants 
    ...
    ser_ss_calc = ser_substation_4nc_compute(ser_ss_dc)
    
    ser_ss_temp_exit_cst = ser_ss_calc[0,0]            ##The constant term for the exit temperature stream 
    ser_ss_constraint_eqn_coeff = ser_ss_calc[1,0]     ##The constraint coefficient term to ensure that the delta t of the hx on the cold side does not exceed max delta t
    ...
    ##Stream 1
    stream = {}                                                                
    stream['Parent'] = 'ser_ss_4nc'                                                ##Temperature stream entering the substation 
    stream['Type'] = 'temp_chil'
    stream['Name'] = 'ser_ss_4nc_tin'
    stream['Layer'] = 'sp12ser_temp'
    stream['Stream_coeff_v1_2'] = 0
    stream['Stream_coeff_v1_1'] = 0
    stream['Stream_coeff_v2_2'] = 0
    stream['Stream_coeff_v2_1'] = (ser_ss_tinmax - 273.15 - 1)
    ...
    ##Stream 2
    stream = {}                                                                
    stream['Parent'] = 'ser_ss_4nc'                                                ##Flowrate stream entering the substation 
    stream['Type'] = 'flow'
    stream['Name'] = 'ser_ss_4nc_mfin'
    stream['Layer'] = 'sernwk2ss_flow'
    stream['Stream_coeff_v1_2'] = 0
    stream['Stream_coeff_v1_1'] = ser_ss_totalflownwk 
    stream['Stream_coeff_v2_2'] = 0
    ...
    ##Stream 3
    stream = {}                                                                
    stream['Parent'] = 'ser_ss_4nc'                                                ##Temperture stream exiting the substation 
    stream['Type'] = 'temp_chil'
    stream['Name'] = 'ser_ss_4nc_tout'
    stream['Layer'] = 'ss2chilret_temp'
    stream['Stream_coeff_v1_2'] = 0
    stream['Stream_coeff_v1_1'] = (273.15 + 1) 
    stream['Stream_coeff_v2_2'] = 0
    stream['Stream_coeff_v2_1'] = 0
    stream['Stream_coeff_v1_v2'] = (ser_ss_tinmax - 273.15 - 1)
    stream['Stream_coeff_cst'] = ser_ss_temp_exit_cst
    stream['InOut'] = 'out'
    ...
    ##Stream 4
    stream = {}                                                                
    stream['Parent'] = 'ser_ss_4nc'                                                ##Flowrate out to the distribution pump
    stream['Type'] = 'flow'
    stream['Name'] = 'ser_ss_4nc_flow_out'
    ...
    ##Term 1
    term = {}
    term['Parent_unit'] = 'ser_ss_4nc'
    term['Parent_eqn'] = 'ser_ss_4nc_tout_max'
    ...
    term['Coeff_v1_1'] = ser_ss_constraint_eqn_coeff
    term['Coeff_v2_2'] = 0
    term['Coeff_v2_1'] = 0
    term['Coeff_v1_v2'] = 0
    term['Coeff_cst'] = -(1 / ser_ss_deltmax)
