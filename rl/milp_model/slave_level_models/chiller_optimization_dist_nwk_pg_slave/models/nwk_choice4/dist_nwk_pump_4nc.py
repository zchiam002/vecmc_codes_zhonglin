...
def dist_nwk_pump_4nc (dist_np_4nc_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    ...
    dist_np_look_up_table_loc = current_directory + 'master_level_models\\\chiller_optimization_dist_nwk_pg_master_level_models\\look_up_tables\\'      ##Distribution pump look up table location 
