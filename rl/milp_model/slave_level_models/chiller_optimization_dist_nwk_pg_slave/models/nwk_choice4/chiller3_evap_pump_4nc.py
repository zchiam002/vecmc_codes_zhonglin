...
def chiller3_evap_pump_4nc (ch3_ep_4nc_mdv, utilitylist, streams, cons_eqns, cons_eqns_terms):
    ...
    import numpy as np
    import os
    current_directory = os.path.dirname(__file__)[:-77] + '//' 
    ...
    ch3_ep_p_look_up_table_loc = current_directory + 'master_level_models\\\chiller_optimization_dist_nwk_pg_master_level_models\\look_up_tables\\'      ##Evaporator pump look up table location 
