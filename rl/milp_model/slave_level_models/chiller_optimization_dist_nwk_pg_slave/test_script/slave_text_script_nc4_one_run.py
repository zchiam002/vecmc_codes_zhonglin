...
def slave_test_script_nc4 ():
    ...
    sys.path.append(current_directory + 'master_level_models\\chiller_optimization_dist_nwk_pg_master_level_models\\')
    sys.path.append(current_directory + 'slave_level_models\\chiller_optimization_dist_nwk_pg_slave\\models\\')    
...
#    prepare_dist_nwk_lin_coeff()
    ...
    demand_type = 'high'
    allocated_hour = 0
    demand_file_loc = current_directory + 'input_data\\chiller_optimization_dist_nwk_pg_input_data\\' + demand_type + '_load\\' + demand_type + '_demand_' + str(allocated_hour) + '.csv'
    
    #Location of weather conditions and the cooling tower coefficients 
    weather_data_dir = current_directory + 'input_data\\chiller_optimization_dist_nwk_pg_input_data\\' + demand_type + '_load\\' + demand_type + '_demand_weather.csv'
