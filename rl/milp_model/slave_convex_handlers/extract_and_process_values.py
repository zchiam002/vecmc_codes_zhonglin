...
def extract_glpk_results (ret_dataframes, utility_list, process_list, bilinear_pieces, parallel_thread_num, affected_list):
    ...
    result_file = current_directory + 'slave_convex_handlers\\solver_lp_format_holder\\' + r'\t' + 'hread_' + str(parallel_thread_num) + '\\out.txt'
...
def extract_gurobi_results (utility_list, process_list, bilinear_pieces, parallel_thread_num):
    ...
    ##Result file location 
    result_file = current_directory + 'slave_convex_handlers\\solver_lp_format_holder\\' + r'\t' + 'hread_' + str(parallel_thread_num) + '\\out.sol'
