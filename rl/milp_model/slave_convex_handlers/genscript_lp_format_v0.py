##This function generates the lp format necessary for the MILP solvers to process the problem 
def genscript_lp_format_v0 (input_dataframes, utilitylist, processlist, layerslist, parallel_thread_num, obj_func, bilinear_pieces):
    
    import os
    current_directory = os.path.dirname(__file__)[:-22] + '//' 
    import sys
    import shutil
    sys.path.append(current_directory + 'slave_convex_handlers\\auxillary\\')
    ...
    master_folder = current_directory + 'slave_convex_handlers\\solver_lp_format_holder\\'
