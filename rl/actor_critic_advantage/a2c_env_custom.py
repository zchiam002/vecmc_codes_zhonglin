...
def one_run_slave (action, state, iteration):
    ...
    import os
    current_directory = os.path.dirname(__file__)[:-23] + '//'    
    import sys
    sys.path.append(current_directory + 'milp_model\\master_level\\auxillary')
    sys.path.append(current_directory + 'milp_model\\master_level_models\\chiller_optimization_dist_nwk_a2c_master_level_models\\')
    sys.path.append(current_directory + 'milp_model\\slave_level_models\chiller_optimization_dist_nwk_a2c_slave\\models\\')    
